...
class KeysDictionaryMemoryTest(unittest.TestCase):
    def test_parsing_and_memory(self):
        ...
        reader = source[source.index("static bool keys_dict_read_line("):source.index("bool keys_dict_check_presence(")]
        ...
        harness = harness.replace("/* PRODUCTION_CODE */", parse_hex + types + reader + convert + next_key)
