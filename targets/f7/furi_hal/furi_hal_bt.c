...
FuriHalBleProfileBase *furi_hal_bt_start_app(const FuriHalBleProfileTemplate *profile_template,
...
FuriHalBleProfileBase *furi_hal_bt_change_app(const FuriHalBleProfileTemplate *profile_template,
...
void furi_hal_bt_dump_state(FuriString *buffer)
{
    ...
    if (furi_hal_bt_is_alive()) {
        ...
        furi_string_cat_printf(buffer,
                               "Ret: %d, HCI_Version: %d, HCI_Revision: %d, LMP_PAL_Version: %d, "
                               "Manufacturer_Name: %d, LMP_PAL_Subversion: %d",
                               ret, HCI_Version, HCI_Revision, LMP_PAL_Version, Manufacturer_Name,
                               LMP_PAL_Subversion);
    } else {
