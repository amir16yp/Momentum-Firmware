...
static void furi_hal_i2c_bus_power_event(FuriHalI2cBus *bus, FuriHalI2cBusEvent event)
{
    if (event == FuriHalI2cBusEventInit) {
        ...
        furi_check(furi_mutex_acquire(furi_hal_i2c_bus_power_mutex, FuriWaitForever) ==
                   FuriStatusOk);
...
static void furi_hal_i2c_bus_external_event(FuriHalI2cBus *bus, FuriHalI2cBusEvent event)
{
    if (event == FuriHalI2cBusEventInit) {
        ...
        furi_check(furi_mutex_acquire(furi_hal_i2c_bus_external_mutex, FuriWaitForever) ==
                   FuriStatusOk);
    } else if (event == FuriHalI2cBusEventUnlock) {
...
void furi_hal_i2c_bus_handle_power_event(const FuriHalI2cBusHandle *handle,
                                         FuriHalI2cBusHandleEvent event)
{
    if (event == FuriHalI2cBusHandleEventActivate) {
        furi_hal_gpio_init_ex(&gpio_i2c_power_sda, GpioModeAltFunctionOpenDrain, GpioPullNo,
                              GpioSpeedLow, GpioAltFn4I2C1);
        furi_hal_gpio_init_ex(&gpio_i2c_power_scl, GpioModeAltFunctionOpenDrain, GpioPullNo,
                              GpioSpeedLow, GpioAltFn4I2C1);
        ...
        furi_hal_gpio_init_ex(&gpio_i2c_power_sda, GpioModeAnalog, GpioPullNo, GpioSpeedLow,
                              GpioAltFnUnused);
        furi_hal_gpio_init_ex(&gpio_i2c_power_scl, GpioModeAnalog, GpioPullNo, GpioSpeedLow,
                              GpioAltFnUnused);
    }
}
...
void furi_hal_i2c_bus_handle_external_event(const FuriHalI2cBusHandle *handle,
                                            FuriHalI2cBusHandleEvent event)
{
    if (event == FuriHalI2cBusHandleEventActivate) {
        furi_hal_gpio_init_ex(&gpio_ext_pc0, GpioModeAltFunctionOpenDrain, GpioPullNo, GpioSpeedLow,
                              GpioAltFn4I2C3);
        furi_hal_gpio_init_ex(&gpio_ext_pc1, GpioModeAltFunctionOpenDrain, GpioPullNo, GpioSpeedLow,
                              GpioAltFn4I2C3);
        ...
        furi_hal_gpio_init_ex(&gpio_ext_pc0, GpioModeAnalog, GpioPullNo, GpioSpeedLow,
                              GpioAltFnUnused);
        furi_hal_gpio_init_ex(&gpio_ext_pc1, GpioModeAnalog, GpioPullNo, GpioSpeedLow,
                              GpioAltFnUnused);
    }
}
