                                                                 ...
                                                                 uint8_t *atqa, uint8_t sak)
{
    ...
    if (uid_len == 4) {
        st25r3916_change_reg_bits(handle, ST25R3916_REG_AUX, ST25R3916_REG_AUX_nfc_id_mask,
...
FuriHalNfcError furi_hal_nfc_iso4443a_listener_tx(const FuriHalSpiBusHandle *handle,
