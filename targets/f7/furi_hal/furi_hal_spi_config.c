...
inline static void furi_hal_spi_bus_r_handle_event_callback(const FuriHalSpiBusHandle *handle,
...
inline static void
furi_hal_spi_bus_external_handle_event_callback(const FuriHalSpiBusHandle *handle,
                                                FuriHalSpiBusHandleEvent event,
                                                const LL_SPI_InitTypeDef *preset)
{
    if (event == FuriHalSpiBusHandleEventInit) {
        ...
        furi_hal_gpio_init_ex(handle->miso, GpioModeAltFunctionPushPull, GpioPullDown,
                              GpioSpeedVeryHigh, GpioAltFn5SPI1);
        furi_hal_gpio_init_ex(handle->mosi, GpioModeAltFunctionPushPull, GpioPullDown,
                              GpioSpeedVeryHigh, GpioAltFn5SPI1);
        furi_hal_gpio_init_ex(handle->sck, GpioModeAltFunctionPushPull, GpioPullDown,
                              GpioSpeedVeryHigh, GpioAltFn5SPI1);
...
inline static void furi_hal_spi_bus_nfc_handle_event_callback(const FuriHalSpiBusHandle *handle,
                                                              FuriHalSpiBusHandleEvent event,
                                                              const LL_SPI_InitTypeDef *preset)
{
    if (event == FuriHalSpiBusHandleEventInit) {
...
static void furi_hal_spi_bus_handle_subghz_event_callback(const FuriHalSpiBusHandle *handle,
                                                          FuriHalSpiBusHandleEvent event)
{
...
static void furi_hal_spi_bus_handle_nfc_event_callback(const FuriHalSpiBusHandle *handle,
                                                       FuriHalSpiBusHandleEvent event)
{
...
static void furi_hal_spi_bus_handle_external_event_callback(const FuriHalSpiBusHandle *handle,
                                                            FuriHalSpiBusHandleEvent event)
{
    furi_hal_spi_bus_external_handle_event_callback(handle, event,
...
inline static void furi_hal_spi_bus_d_handle_event_callback(const FuriHalSpiBusHandle *handle,
                                                            FuriHalSpiBusHandleEvent event,
                                                            const LL_SPI_InitTypeDef *preset)
{
    if (event == FuriHalSpiBusHandleEventInit) {
...
static void furi_hal_spi_bus_handle_display_event_callback(const FuriHalSpiBusHandle *handle,
                                                           FuriHalSpiBusHandleEvent event)
{
...
static void furi_hal_spi_bus_handle_sd_fast_event_callback(const FuriHalSpiBusHandle *handle,
                                                           FuriHalSpiBusHandleEvent event)
{
...
static void furi_hal_spi_bus_handle_sd_slow_event_callback(const FuriHalSpiBusHandle *handle,
                                                           FuriHalSpiBusHandleEvent event)
{
