...
const FuriHalRegion furi_hal_region_zero = {.country_code = "00",
                                            .bands_count = 1,
                                            .bands = {
                                                {
                                                    .start = 0,
...
const FuriHalRegion furi_hal_region_eu_ru = {.country_code = "EU",
                                             .bands_count = 2,
                                             .bands = {{
                                                           .start = 433050000,
                                                           .end = 434790000,
...
const FuriHalRegion furi_hal_region_us_ca_au = {.country_code = "US",
                                                .bands_count = 3,
                                                .bands = {{
                                                              .start = 304100000,
                                                              .end = 321950000,
...
const FuriHalRegion furi_hal_region_jp = {.country_code = "JP",
                                          .bands_count = 2,
                                          .bands = {{
                                                        .start = 312000000,
                                                        .end = 315250000,
