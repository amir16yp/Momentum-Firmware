...
static void furi_hal_serial_async_rx_configure(FuriHalSerialHandle *handle,
    ...
    if (furi_hal_serial[FuriHalSerialIdUsart].buffer_rx_ptr == NULL) {
        if (furi_hal_serial[FuriHalSerialIdUsart].rx_byte_callback) {
            furi_hal_serial[FuriHalSerialIdUsart].rx_byte_callback(
                furi_hal_serial[FuriHalSerialIdUsart].handle, event,
...
static void furi_hal_serial_usart_dma_rx_isr(void *context)
{
    ...
    if (LL_DMA_IsActiveFlag_HT6(FURI_HAL_SERIAL_USART_DMA_INSTANCE)) {
        ...
        furi_hal_serial[FuriHalSerialIdUsart].buffer_rx_index_write =
            ...
            LL_DMA_GetDataLength(FURI_HAL_SERIAL_USART_DMA_INSTANCE,
        ...
        if ((furi_hal_serial[FuriHalSerialIdUsart].buffer_rx_index_read >
            ...
            if (furi_hal_serial[FuriHalSerialIdUsart].rx_dma_callback) {
                furi_hal_serial[FuriHalSerialIdUsart].rx_dma_callback(
                    furi_hal_serial[FuriHalSerialIdUsart].handle, FuriHalSerialRxEventData,
                    furi_hal_serial_dma_bytes_available(FuriHalSerialIdUsart),
                    furi_hal_serial[FuriHalSerialIdUsart].context);
            }
        }
...
static void furi_hal_serial_usart_init_dma_rx(void)
{
    ...
    LL_DMA_SetMemoryAddress(FURI_HAL_SERIAL_USART_DMA_INSTANCE, FURI_HAL_SERIAL_USART_DMA_CHANNEL,
                            (uint32_t)furi_hal_serial[FuriHalSerialIdUsart].buffer_rx_ptr);
    LL_DMA_SetPeriphAddress(FURI_HAL_SERIAL_USART_DMA_INSTANCE, FURI_HAL_SERIAL_USART_DMA_CHANNEL,
                            (uint32_t) & (USART1->RDR));

    LL_DMA_ConfigTransfer(FURI_HAL_SERIAL_USART_DMA_INSTANCE, FURI_HAL_SERIAL_USART_DMA_CHANNEL,
                          LL_DMA_DIRECTION_PERIPH_TO_MEMORY | LL_DMA_MODE_CIRCULAR |
                              LL_DMA_PERIPH_NOINCREMENT | LL_DMA_MEMORY_INCREMENT |
                              LL_DMA_PDATAALIGN_BYTE | LL_DMA_MDATAALIGN_BYTE |
                              LL_DMA_PRIORITY_HIGH);
    LL_DMA_SetDataLength(FURI_HAL_SERIAL_USART_DMA_INSTANCE, FURI_HAL_SERIAL_USART_DMA_CHANNEL,
                         FURI_HAL_SERIAL_DMA_BUFFER_SIZE);
    LL_DMA_SetPeriphRequest(FURI_HAL_SERIAL_USART_DMA_INSTANCE, FURI_HAL_SERIAL_USART_DMA_CHANNEL,
...
{
    if (furi_hal_serial[FuriHalSerialIdUsart].buffer_rx_ptr != NULL) {
        LL_DMA_DisableChannel(FURI_HAL_SERIAL_USART_DMA_INSTANCE,
                              FURI_HAL_SERIAL_USART_DMA_CHANNEL);
...
static void furi_hal_serial_usart_init(FuriHalSerialHandle *handle, uint32_t baud)
{
    ...
    furi_hal_gpio_init_ex(&gpio_usart_tx, GpioModeAltFunctionPushPull, GpioPullUp,
                          GpioSpeedVeryHigh, GpioAltFn7USART1);
    furi_hal_gpio_init_ex(&gpio_usart_rx, GpioModeAltFunctionPushPull, GpioPullUp,
                          GpioSpeedVeryHigh, GpioAltFn7USART1);
    ...
    if (furi_hal_serial[FuriHalSerialIdLpuart].buffer_rx_ptr == NULL) {
        if (furi_hal_serial[FuriHalSerialIdLpuart].rx_byte_callback) {
            furi_hal_serial[FuriHalSerialIdLpuart].rx_byte_callback(
                furi_hal_serial[FuriHalSerialIdLpuart].handle, event,
...
static void furi_hal_serial_lpuart_dma_rx_isr(void *context)
{
    ...
    if (LL_DMA_IsActiveFlag_HT7(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE)) {
        ...
        furi_hal_serial[FuriHalSerialIdLpuart].buffer_rx_index_write =
            FURI_HAL_SERIAL_DMA_BUFFER_SIZE -
            LL_DMA_GetDataLength(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE,
        ...
        if ((furi_hal_serial[FuriHalSerialIdLpuart].buffer_rx_index_read >
            ...
            if (furi_hal_serial[FuriHalSerialIdLpuart].rx_dma_callback) {
                furi_hal_serial[FuriHalSerialIdLpuart].rx_dma_callback(
                    furi_hal_serial[FuriHalSerialIdLpuart].handle, FuriHalSerialRxEventData,
                    furi_hal_serial_dma_bytes_available(FuriHalSerialIdLpuart),
                    furi_hal_serial[FuriHalSerialIdLpuart].context);
            }
        }
...
static void furi_hal_serial_lpuart_init_dma_rx(void)
{
    ...
    LL_DMA_SetMemoryAddress(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE, FURI_HAL_SERIAL_LPUART_DMA_CHANNEL,
                            (uint32_t)furi_hal_serial[FuriHalSerialIdLpuart].buffer_rx_ptr);
    LL_DMA_SetPeriphAddress(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE, FURI_HAL_SERIAL_LPUART_DMA_CHANNEL,
                            (uint32_t) & (LPUART1->RDR));

    LL_DMA_ConfigTransfer(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE, FURI_HAL_SERIAL_LPUART_DMA_CHANNEL,
                          LL_DMA_DIRECTION_PERIPH_TO_MEMORY | LL_DMA_MODE_CIRCULAR |
                              LL_DMA_PERIPH_NOINCREMENT | LL_DMA_MEMORY_INCREMENT |
                              LL_DMA_PDATAALIGN_BYTE | LL_DMA_MDATAALIGN_BYTE |
                              LL_DMA_PRIORITY_HIGH);
    LL_DMA_SetDataLength(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE, FURI_HAL_SERIAL_LPUART_DMA_CHANNEL,
                         FURI_HAL_SERIAL_DMA_BUFFER_SIZE);
    LL_DMA_SetPeriphRequest(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE, FURI_HAL_SERIAL_LPUART_DMA_CHANNEL,
...
{
    if (furi_hal_serial[FuriHalSerialIdLpuart].buffer_rx_ptr != NULL) {
        LL_DMA_DisableChannel(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE,
                              FURI_HAL_SERIAL_LPUART_DMA_CHANNEL);
        LL_USART_DisableDMAReq_RX(LPUART1);

        LL_USART_DisableIT_IDLE(LPUART1);
        LL_DMA_DisableIT_TC(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE,
                            FURI_HAL_SERIAL_LPUART_DMA_CHANNEL);
        LL_DMA_DisableIT_HT(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE,
                            FURI_HAL_SERIAL_LPUART_DMA_CHANNEL);
...
static void furi_hal_serial_lpuart_init(FuriHalSerialHandle *handle, uint32_t baud)
{
    ...
    furi_hal_gpio_init_ex(&gpio_ext_pc0, GpioModeAltFunctionPushPull, GpioPullUp, GpioSpeedVeryHigh,
                          GpioAltFn8LPUART1);
...
void furi_hal_serial_set_br(FuriHalSerialHandle *handle, uint32_t baud)
{
    ...
    if (handle->id == FuriHalSerialIdUsart) {
        if (LL_USART_IsEnabled(USART1)) {
            ...
            LL_USART_SetBaudRate(USART1, uartclk, prescaler, FURI_HAL_SERIAL_USART_OVERSAMPLING,
                                 baud);
            LL_USART_Enable(USART1);
        }
    } else if (handle->id == FuriHalSerialIdLpuart) {
...
static void furi_hal_serial_usart_configure_framing(FuriHalSerialDataBits data_bits,
...
static void furi_hal_serial_lpuart_configure_framing(FuriHalSerialDataBits data_bits,
                                                     FuriHalSerialParity parity,
                                                     FuriHalSerialStopBits stop_bits)
{
                                       ...
                                       FuriHalSerialParity parity, FuriHalSerialStopBits stop_bits)
{
    ...
    if (data_bits == FuriHalSerialDataBits9)
        furi_check(parity == FuriHalSerialParityNone);
...
static void furi_hal_serial_event_deinit(FuriHalSerialHandle *handle)
{
    if (handle->id == FuriHalSerialIdUsart) {
        ...
        if (LL_LPUART_IsEnabledIT_IDLE(LPUART1))
            LL_LPUART_DisableIT_IDLE(LPUART1);
        if (LL_LPUART_IsEnabledIT_ERROR(LPUART1))
            LL_LPUART_DisableIT_ERROR(LPUART1);
    }
}
                                               ...
                                               FuriHalSerialAsyncRxCallback callback, void *context)
{
    ...
    if (callback) {
        if (handle->id == FuriHalSerialIdUsart) {
            furi_hal_serial_usart_deinit_dma_rx();
            furi_hal_interrupt_set_isr(FuriHalInterruptIdUart1, furi_hal_serial_usart_irq_callback,
                                       NULL);
            LL_USART_EnableIT_RXNE_RXFNE(USART1);
        } else if (handle->id == FuriHalSerialIdLpuart) {
            furi_hal_serial_lpuart_deinit_dma_rx();
            furi_hal_interrupt_set_isr(FuriHalInterruptIdLpUart1,
                                       furi_hal_serial_lpuart_irq_callback, NULL);
                                    ...
                                    bool report_errors)
{
    ...
    furi_check(furi_hal_serial[FuriHalSerialIdUsart].rx_byte_callback !=
               furi_hal_serial[FuriHalSerialIdLpuart].rx_byte_callback);
}
...
static size_t furi_hal_serial_dma_bytes_available(FuriHalSerialId ch)
{
    ...
    if (ch == FuriHalSerialIdUsart) {
        dma_remain = LL_DMA_GetDataLength(FURI_HAL_SERIAL_USART_DMA_INSTANCE,
                                          FURI_HAL_SERIAL_USART_DMA_CHANNEL);
    } else if (ch == FuriHalSerialIdLpuart) {
        dma_remain = LL_DMA_GetDataLength(FURI_HAL_SERIAL_LPUART_DMA_INSTANCE,
                                          FURI_HAL_SERIAL_LPUART_DMA_CHANNEL);
    } else {
        furi_crash();
    }
    ...
    if (furi_hal_serial[ch].buffer_rx_index_write >= furi_hal_serial[ch].buffer_rx_index_read) {
        return furi_hal_serial[ch].buffer_rx_index_write - furi_hal_serial[ch].buffer_rx_index_read;
    } else {
...
static void furi_hal_serial_dma_configure(FuriHalSerialHandle *handle,
                                          FuriHalSerialDmaRxCallback callback, void *context)
{
    // Disable RXFNE interrupts before unsetting the user callback that reads data
    // Otherwise interrupt runs without reading data and without clearing RXFNE flag
    // This would cause a system hang as the same interrupt runs in loop forever
                                  ...
                                  void *context, bool report_errors)
{
    ...
    // Assign different functions to different UARTs
    furi_check(furi_hal_serial[FuriHalSerialIdUsart].rx_dma_callback !=
               furi_hal_serial[FuriHalSerialIdLpuart].rx_dma_callback);
}
...
void furi_hal_serial_enable_direction(FuriHalSerialHandle *handle, FuriHalSerialDirection direction)
{
    ...
    furi_hal_gpio_init_ex(gpio, GpioModeAltFunctionPushPull, GpioPullUp, GpioSpeedVeryHigh, alt_fn);
}
