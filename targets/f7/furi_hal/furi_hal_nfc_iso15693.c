...
static FuriHalNfcError furi_hal_nfc_iso15693_poller_init(const FuriHalSpiBusHandle *handle)
{
    ...
    st25r3916_change_reg_bits(
        handle, ST25R3916_REG_MODE, ST25R3916_REG_MODE_om_mask | ST25R3916_REG_MODE_tr_am,
    ...
    st25r3916_clear_reg_bits(handle, ST25R3916_REG_AUX_MOD,
...
static void iso15693_3_poller_encode_frame(const uint8_t *tx_data, size_t tx_bits,
...
static FuriHalNfcError iso15693_3_poller_decode_frame(const uint8_t *buf, size_t buf_bits,
                                                      uint8_t *buf_decoded, size_t buf_decoded_size,
                                                      size_t *buf_decoded_bits)
{
    ...
    do {
        ...
        for (uint32_t i = FURI_HAL_NFC_ISO15693_RESP_SOF_SIZE;
             i < buf_bits - FURI_HAL_NFC_ISO15693_RESP_SOF_SIZE; i += BITS_IN_BYTE / 4) {
...
static FuriHalNfcError furi_hal_nfc_iso15693_poller_tx(const FuriHalSpiBusHandle *handle,
                                                       const uint8_t *tx_data, size_t tx_bits)
{
    FuriHalNfcIso15693Poller *instance = furi_hal_nfc_iso15693_poller;
    iso15693_3_poller_encode_frame(tx_data, tx_bits, instance->frame_buf,
                                   sizeof(instance->frame_buf), &instance->frame_buf_bits);
    return furi_hal_nfc_poller_tx_common(handle, instance->frame_buf, instance->frame_buf_bits);
}

static FuriHalNfcError furi_hal_nfc_iso15693_poller_rx(const FuriHalSpiBusHandle *handle,
                                                       ...
                                                       size_t *rx_bits)
{
    ...
    do {
        error = furi_hal_nfc_common_fifo_rx(handle, instance->fifo_buf, sizeof(instance->fifo_buf),
                                            &instance->fifo_buf_bits);
        if (error != FuriHalNfcErrorNone)
            break;

        error = iso15693_3_poller_decode_frame(instance->fifo_buf, instance->fifo_buf_bits,
                                               instance->frame_buf, sizeof(instance->frame_buf),
...
static void furi_hal_nfc_iso15693_listener_transparent_mode_enter(const FuriHalSpiBusHandle *handle)
{
...
static void furi_hal_nfc_iso15693_listener_transparent_mode_exit(const FuriHalSpiBusHandle *handle)
{
...
static FuriHalNfcError furi_hal_nfc_iso15693_listener_init(const FuriHalSpiBusHandle *handle)
{
    ...
    st25r3916_change_reg_bits(handle, ST25R3916_REG_MODE,
                              ST25R3916_REG_MODE_om_mask | ST25R3916_REG_MODE_tr_am,
                              ST25R3916_REG_MODE_om_targ_nfca | ST25R3916_REG_MODE_tr_am_ook);

    st25r3916_change_reg_bits(handle, ST25R3916_REG_OP_CONTROL, ST25R3916_REG_OP_CONTROL_rx_en,
                              ST25R3916_REG_OP_CONTROL_rx_en);

    // Enable passive target mode
    st25r3916_change_reg_bits(handle, ST25R3916_REG_MODE, ST25R3916_REG_MODE_targ,
...
static FuriHalNfcError furi_hal_nfc_iso15693_listener_tx_transparent(const uint8_t *data,
                                                                     size_t data_size)
{
    iso15693_signal_tx(furi_hal_nfc_iso15693_listener->signal, Iso15693SignalDataRateHi, data,
                       data_size);
...
static FuriHalNfcEvent furi_hal_nfc_iso15693_wait_event(uint32_t timeout_ms)
{
    ...
    iso15693_parser_start(furi_hal_nfc_iso15693_listener->parser,
                          furi_hal_nfc_iso15693_parser_callback, thread_id);
...
static FuriHalNfcError furi_hal_nfc_iso15693_listener_tx(const FuriHalSpiBusHandle *handle,
                                                         const uint8_t *tx_data, size_t tx_bits)
{
    UNUSED(handle);
    furi_check(furi_hal_nfc_iso15693_listener);
...
static FuriHalNfcError furi_hal_nfc_iso15693_listener_rx(const FuriHalSpiBusHandle *handle,
                                                         uint8_t *rx_data, size_t rx_data_size,
                                                         size_t *rx_bits)
{
    furi_check(furi_hal_nfc_iso15693_listener);
    ...
    iso15693_parser_get_data(furi_hal_nfc_iso15693_listener->parser, rx_data, rx_data_size,
                             rx_bits);
