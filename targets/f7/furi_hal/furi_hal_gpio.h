 ...
 */
void furi_hal_gpio_init(const GpioPin *gpio, const GpioMode mode, const GpioPull pull,
 ...
 */
void furi_hal_gpio_init_ex(const GpioPin *gpio, const GpioMode mode, const GpioPull pull,
                           const GpioSpeed speed, const GpioAltFn alt_fn);
