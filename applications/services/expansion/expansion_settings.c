...
void expansion_settings_load(ExpansionSettings *settings)
{
    ...
    const bool success =
        saved_struct_load(EXPANSION_SETTINGS_PATH, settings, sizeof(ExpansionSettings),
                          EXPANSION_SETTINGS_MAGIC, EXPANSION_SETTINGS_VERSION);
...
void expansion_settings_save(const ExpansionSettings *settings)
{
    ...
    const bool success =
        saved_struct_save(EXPANSION_SETTINGS_PATH, settings, sizeof(ExpansionSettings),
                          EXPANSION_SETTINGS_MAGIC, EXPANSION_SETTINGS_VERSION);
