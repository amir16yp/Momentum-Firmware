...
typedef enum {
    ...
    LoaderStatusErrorApiMismatchCanceled, //<! Will bypass GUI error after API mismatch warning was
                                          //canceled
} LoaderStatus;
 ...
 */
void loader_enqueue_launch(Loader *instance, const char *name, const char *args,
