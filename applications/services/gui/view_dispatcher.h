 ...
 *
 * ViewDispatcher is used to connect several Views to a Gui instance, switch between them and handle
 * various events. This is useful in applications featuring an advanced graphical user interface.
 *
 ...
 *
 * If no multi-view or complex event handling capabilities are required, consider using ViewHolder
 * instead.
 *
...
typedef enum {
    ViewDispatcherTypeDesktop,   /**< Desktop layer: fullscreen with status bar on top of it. For
                                    internal usage. */
