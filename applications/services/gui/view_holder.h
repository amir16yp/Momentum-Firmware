 ...
 *
 * ViewHolder is used to connect a single View to a Gui instance. This is useful in smaller
 * applications with a simple user interface. If advanced view switching capabilites are required,
 * consider using ViewDispatcher instead.
 *
 ...
 */
void view_holder_set_free_callback(ViewHolder *view_holder, FreeCallback free_callback,
                                   void *free_context);

/**
 * @brief Free callback context getter.
 *
 * Useful if your Free callback is a module destructor, so you can get an instance of the module
 * using this method.
 *
 * @param view_holder ViewHolder instance
 ...
 */
void view_holder_set_back_callback(ViewHolder *view_holder, BackCallback back_callback,
                                   void *back_context);
