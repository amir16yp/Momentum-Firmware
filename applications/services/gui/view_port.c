...
_Static_assert((ViewPortOrientationHorizontal == 0 && ViewPortOrientationHorizontalFlip == 1 &&
...
_Static_assert((InputKeyUp == 0 && InputKeyDown == 1 && InputKeyRight == 2 && InputKeyLeft == 3 &&
...
static const InputKey view_port_input_mapping[ViewPortOrientationMAX][InputKeyMAX] = {
    {InputKeyUp, InputKeyDown, InputKeyRight, InputKeyLeft, InputKeyOk,
    ...
    {InputKeyRight, InputKeyLeft, InputKeyDown, InputKeyUp, InputKeyOk,
...
void view_port_enabled_set(ViewPort *view_port, bool enabled)
{
    ...
    // Make sure that you don't call viewport methods inside of another mutex, especially one that
    // is used in draw call
