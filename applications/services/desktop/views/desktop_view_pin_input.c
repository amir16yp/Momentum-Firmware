...
static void desktop_view_pin_input_draw(Canvas *canvas, void *context)
{
    ...
    if (model->secondary_str) {
        canvas_set_font(canvas, FontSecondary);
        canvas_draw_str(canvas, model->secondary_str_x, model->secondary_str_y,
                        model->secondary_str);
    }

    if (model->tertiary_str && model->pin.length == 0) {
        canvas_set_font(canvas, FontSecondary);
        canvas_draw_str_aligned(canvas, model->tertiary_str_x, model->tertiary_str_y, AlignCenter,
                                AlignBottom, model->tertiary_str);
    }
}
...
void desktop_view_pin_input_set_label_primary(DesktopViewPinInput *pin_input, uint8_t x, uint8_t y,
                                              const char *label)
{
    furi_assert(pin_input);
...
void desktop_view_pin_input_set_label_secondary(DesktopViewPinInput *pin_input, uint8_t x,
                                                uint8_t y, const char *label)
{
    furi_assert(pin_input);
...
void desktop_view_pin_input_set_label_tertiary(DesktopViewPinInput *pin_input, uint8_t x, uint8_t y,
                                               const char *label)
{
    furi_assert(pin_input);
...
void desktop_view_pin_input_set_timeout_callback(DesktopViewPinInput *pin_input,
...
void desktop_view_pin_input_set_back_callback(DesktopViewPinInput *pin_input,
                                              DesktopViewPinInputCallback callback)
{
    furi_assert(pin_input);
...
void desktop_view_pin_input_set_done_callback(DesktopViewPinInput *pin_input,
