...
void desktop_settings_load(DesktopSettings *settings)
{
    ...
    const bool success = saved_struct_load(DESKTOP_SETTINGS_PATH, settings, sizeof(DesktopSettings),
                                           DESKTOP_SETTINGS_MAGIC, DESKTOP_SETTINGS_VER);
...
void desktop_settings_save(const DesktopSettings *settings)
{
    ...
    const bool success = saved_struct_save(DESKTOP_SETTINGS_PATH, settings, sizeof(DesktopSettings),
                                           DESKTOP_SETTINGS_MAGIC, DESKTOP_SETTINGS_VER);
