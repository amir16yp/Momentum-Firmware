...
void notification_message_block(NotificationApp *app, const NotificationSequence *sequence)
{
    ...
    NotificationAppMessage m = {.type = NotificationLayerMessage,
                                .sequence = sequence,
...
void notification_internal_message_block(NotificationApp *app, const NotificationSequence *sequence)
{
    furi_check(app);
    furi_check(sequence);
