 ...
 * @brief Example application demonstrating the use of the FuriEventFlag primitive in FuriEventLoop
 * instances.
 *
...
static void event_loop_event_flags_app_event_flags_callback(FuriEventLoopObject *object,
                                                            void *context)
{
    furi_assert(context);
    EventLoopEventFlagsApp *app = context;
...
static EventLoopEventFlagsApp *event_loop_event_flags_app_alloc(void)
{
    ...
    furi_event_loop_subscribe_event_flag(app->event_loop, app->event_flag,
                                         FuriEventLoopEventIn | FuriEventLoopEventFlagEdge,
                                         event_loop_event_flags_app_event_flags_callback, app);
