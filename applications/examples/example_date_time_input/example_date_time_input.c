...
static ExampleDateTimeInput *example_date_time_input_alloc()
{
    ...
    view_dispatcher_set_custom_event_callback(app->view_dispatcher,
                                              example_date_time_input_custom_event_callback);
    view_dispatcher_set_navigation_event_callback(app->view_dispatcher,
                                                  example_date_time_input_back_event_callback);

    app->date_time_input = date_time_input_alloc();
    view_dispatcher_add_view(app->view_dispatcher, ExampleDateTimeInputViewIdDateTimeInput,
                             date_time_input_get_view(app->date_time_input));

    app->dialog_ex = dialog_ex_alloc();
    view_dispatcher_add_view(app->view_dispatcher, ExampleDateTimeInputViewIdShowDateTime,
