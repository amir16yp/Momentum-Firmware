...
void example_date_time_input_scene_input_date_time_on_enter(void *context)
{
    ...
    date_time_input_set_result_callback(date_time_input, NULL,
                                        example_date_time_input_scene_input_date_time_callback,
                                        context, &app->date_time);

    date_time_input_set_editable_fields(date_time_input,

                                        app->edit_date, app->edit_date, app->edit_date,

                                        app->edit_time, app->edit_time, app->edit_time);
