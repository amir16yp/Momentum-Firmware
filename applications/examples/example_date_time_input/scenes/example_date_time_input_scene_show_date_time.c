...
static void example_date_time_input_scene_confirm_dialog_callback(DialogExResult result,
                                                                  void *context)
{
...
static void example_date_time_input_scene_update_view(void *context)
{
    ...
    char buffer[29] = {};
    snprintf(buffer, sizeof(buffer), "%04d-%02d-%02d\n%02d:%02d:%02d%s", app->date_time.year,
             app->date_time.month, app->date_time.day, hour, app->date_time.minute,
             app->date_time.second, label_hour);
    ...
    dialog_ex_set_result_callback(dialog_ex, example_date_time_input_scene_confirm_dialog_callback);
