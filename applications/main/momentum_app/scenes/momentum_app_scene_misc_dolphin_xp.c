...
static void momentum_app_scene_misc_dolphin_xp_number_input_callback(void *context, int32_t number)
{
...
void momentum_app_scene_misc_dolphin_xp_on_enter(void *context)
{
    ...
    number_input_set_result_callback(number_input,
                                     momentum_app_scene_misc_dolphin_xp_number_input_callback, app,
                                     0, 0, DOLPHIN_MAX_XP);
