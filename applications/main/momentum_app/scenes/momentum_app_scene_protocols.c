...
void momentum_app_scene_protocols_on_enter(void *context)
{
    ...
    item = variable_item_list_add(var_item_list, "SubGHz Bypass Region Lock", 2,
                                  momentum_app_scene_protocols_subghz_bypass_changed, app);
    ...
    item = variable_item_list_add(var_item_list, "SubGHz Extend Freq Bands", 2,
                                  momentum_app_scene_protocols_subghz_extend_changed, app);
    ...
    item = variable_item_list_add(var_item_list, "File Naming Prefix", 2,
                                  momentum_app_scene_protocols_file_naming_prefix_changed, app);
    ...
    variable_item_list_set_enter_callback(var_item_list,
                                          momentum_app_scene_protocols_var_item_list_callback, app);
