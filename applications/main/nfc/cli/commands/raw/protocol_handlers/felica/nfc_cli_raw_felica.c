...
static inline NfcCliRawError nfc_cli_raw_felica_activate(NfcGenericInstance *poller,
...
static inline NfcCliRawError nfc_cli_raw_felica_txrx(NfcGenericInstance *poller,
...
NfcCommand nfc_cli_raw_felica_handler(NfcGenericInstance *poller, const NfcCliRawRequest *request,
