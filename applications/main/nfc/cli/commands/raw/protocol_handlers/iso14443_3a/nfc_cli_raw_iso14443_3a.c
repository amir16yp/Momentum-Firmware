...
static void iso14443_3a_format_activation_data(const Iso14443_3aData *data, FuriString *output)
{
    ...
    furi_string_cat_printf(output, " ATQA: %02X%02X SAK: %02X", data->atqa[0], data->atqa[1],
                           data->sak);
}

static inline NfcCliRawError nfc_cli_raw_iso14443_3a_activate(NfcGenericInstance *poller,
...
static inline NfcCliRawError nfc_cli_raw_iso14443_3a_txrx(NfcGenericInstance *poller,
                                                          BitBuffer *tx_buffer,
...
NfcCommand nfc_cli_raw_iso14443_3a_handler(NfcGenericInstance *poller,
