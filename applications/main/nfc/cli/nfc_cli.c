...
static void nfc_cli_subscribe_commands(NfcCliContext *instance)
{
    ...
    for (size_t i = 0; i < cnt; i++) {
        ...
        cli_registry_add_command(instance->registry, name, CliCommandFlagParallelSafe, callback,
...
static NfcCliContext *nfc_cli_alloc(PipeSide *pipe)
{
    ...
    instance->shell = cli_shell_alloc(nfc_cli_shell_motd, instance, pipe, instance->registry, NULL);
