...
void nfc_render_mf_ultralight_pwd_pack(const MfUltralightData *data, FuriString *str)
{
    ...
    if (has_config) {
        furi_string_cat_printf(str, "\nPassword: ");
        nfc_render_iso14443_3a_format_bytes(str, config->password.data,
...
void nfc_render_mf_ultralight_info(const MfUltralightData *data, NfcProtocolFormatType format_type,
                                   FuriString *str)
{
