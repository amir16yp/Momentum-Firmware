...
static NfcCommand nfc_scene_read_poller_callback_iso14443_4b(NfcGenericEvent event, void *context)
{
    ...
    if (iso14443_4b_event->type == Iso14443_4bPollerEventTypeReady) {
        nfc_device_set_data(instance->nfc_device, NfcProtocolIso14443_4b,
