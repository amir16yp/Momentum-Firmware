...
static const MfClassicKeyPair kazan_1k_keys_v1[] = {
    ...
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xE954024EE754, .b = 0x0CD464CDC100}, {.a = 0xBC305FE2DA65, .b = 0xCF0EC6ACF2F9},
    {.a = 0xF7A545095C49, .b = 0x6862FD600F78}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
};
...
static const MfClassicKeyPair kazan_1k_keys_v2[] = {
    ...
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0x2058EAEE8446, .b = 0xCB9B23815F87}, {.a = 0x492F3744A1DC, .b = 0x6B770AADA274},
    {.a = 0xF7A545095C49, .b = 0x6862FD600F78}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
    {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF}, {.a = 0xFFFFFFFFFFFF, .b = 0xFFFFFFFFFFFF},
};
...
static const MfClassicKeyPair kazan_1k_keys_v3[] = {
    {.a = 0x165D3B5280C0, .b = 0xFC7C2BB34E0F}, {.a = 0xC178E3DA7A39, .b = 0xC70FB78B4934},
    {.a = 0x1BDF96089D2F, .b = 0x9500F058ABC5}, {.a = 0xB65AA70AD524, .b = 0x733A63B8B7F3},
    {.a = 0x8BDB8FECDCAF, .b = 0xB0048EE71C0F}, {.a = 0xBC10468ABF05, .b = 0x1700A7D5C034},
    {.a = 0xE7F3282E0C7D, .b = 0x65909B89BDA5}, {.a = 0x986C63DD0355, .b = 0x901C125ED37D},
    {.a = 0x2058EAEE8446, .b = 0xCB9B23815F87}, {.a = 0x492F3744A1DC, .b = 0x6B770AADA274},
    {.a = 0x87EB933B9BF7, .b = 0xFC98A9460EE5}, {.a = 0x7EBC8337F8F0, .b = 0x887C97E53DBC},
    {.a = 0xA369BF6D4452, .b = 0x03BBA7CA2F24}, {.a = 0x37569D7992EF, .b = 0x710BBD01B3B8},
    {.a = 0xD4AA94C4B5E8, .b = 0x7F5C4D210F0B}, {.a = 0x521B8C4B2123, .b = 0x2D2392CC43A7},
};
...
static bool kazan_verify(Nfc *nfc)
{
    ...
    do {
        ...
        bit_lib_num_to_bytes_be(kazan_1k_keys_v1[verification_sector_number].a,
                                COUNT_OF(key_1.data), key_1.data);

        MfClassicAuthContext auth_context;
        MfClassicError error = mf_classic_poller_sync_auth(nfc, verification_block_number, &key_1,
                                                           MfClassicKeyTypeA, &auth_context);
        if (error != MfClassicErrorNone) {
            FURI_LOG_D(TAG, "Failed to read block %u: %d. Keys: v1", verification_block_number,
                       error);

            MfClassicKey key_2 = {0};
            bit_lib_num_to_bytes_be(kazan_1k_keys_v2[verification_sector_number].a,
                                    COUNT_OF(key_2.data), key_2.data);

            MfClassicAuthContext auth_context;
            MfClassicError error = mf_classic_poller_sync_auth(
                nfc, verification_block_number, &key_2, MfClassicKeyTypeA, &auth_context);
            if (error != MfClassicErrorNone) {
                FURI_LOG_D(TAG, "Failed to read block %u: %d. Keys: v2", verification_block_number,
                           error);
                break;
            }
        }
...
static bool kazan_read(Nfc *nfc, NfcDevice *device)
{
    ...
    do {
        ...
        for (size_t i = 0; i < mf_classic_get_total_sectors_num(data->type); i++) {
            bit_lib_num_to_bytes_be(kazan_1k_keys_v1[i].a, sizeof(MfClassicKey),
                                    keys_v1.key_a[i].data);
            bit_lib_num_to_bytes_be(kazan_1k_keys_v2[i].a, sizeof(MfClassicKey),
                                    keys_v2.key_a[i].data);
            bit_lib_num_to_bytes_be(kazan_1k_keys_v3[i].a, sizeof(MfClassicKey),
                                    keys_v3.key_a[i].data);

            FURI_BIT_SET(keys_v1.key_a_mask, i);
            FURI_BIT_SET(keys_v2.key_a_mask, i);
            FURI_BIT_SET(keys_v3.key_a_mask, i);

            bit_lib_num_to_bytes_be(kazan_1k_keys_v1[i].b, sizeof(MfClassicKey),
                                    keys_v1.key_b[i].data);
            bit_lib_num_to_bytes_be(kazan_1k_keys_v2[i].b, sizeof(MfClassicKey),
                                    keys_v2.key_b[i].data);
            bit_lib_num_to_bytes_be(kazan_1k_keys_v3[i].b, sizeof(MfClassicKey),
                                    keys_v3.key_b[i].data);
...
static bool kazan_parse(const NfcDevice *device, FuriString *parsed_data)
{
    ...
    do {
        ...
        furi_string_cat_printf(parsed_data, "\e#Kazan transport card\nCard number: %lu\n",
                               card_number);
        ...
        if (subscription_type == SUBSCRIPTION_TYPE_PURSE) {
            furi_string_cat_printf(
                parsed_data, "Type: purse\nBalance: %lu RUR\nBalance valid:\nfrom: %s\nto: %s",
                trip_counter, furi_string_get_cstr(valid_from_str),
        ...
        if (subscription_type == SUBSCRIPTION_TYPE_ABONNEMENT_BY_TRIPS) {
            furi_string_cat_printf(
                parsed_data,
                "Type: abonnement\nTariff: %s\nTrips left: %lu\nCard valid:\nfrom: %s\nto: %s",
                furi_string_get_cstr(tariff_name), trip_counter,
                furi_string_get_cstr(valid_from_str), furi_string_get_cstr(valid_to_str));
        }
