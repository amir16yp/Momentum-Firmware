...
NfcCommand nfc_scene_mf_ultralight_capture_pass_worker_callback(NfcGenericEvent event,
                                                                void *context)
{
...
void nfc_scene_mf_ultralight_capture_pass_on_enter(void *context)
{
    ...
    // Setup view
    widget_add_string_multiline_element(instance->widget, 54, 30, AlignLeft, AlignCenter,
                                        FontPrimary, "Touch the\nreader to get\npassword...");
    ...
    nfc_listener_start(instance->listener, nfc_scene_mf_ultralight_capture_pass_worker_callback,
                       instance);
