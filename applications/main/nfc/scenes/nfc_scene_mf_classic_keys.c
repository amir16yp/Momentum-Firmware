...
void nfc_scene_mf_classic_keys_on_enter(void *context)
{
    ...
    KeysDict *dict = keys_dict_alloc(NFC_APP_MF_CLASSIC_DICT_SYSTEM_PATH, KeysDictModeOpenExisting,
                                     sizeof(MfClassicKey));
    ...
    dict = keys_dict_alloc(NFC_APP_MF_CLASSIC_DICT_USER_PATH, KeysDictModeOpenAlways,
                           sizeof(MfClassicKey));
    ...
    widget_add_button_element(instance->widget, GuiButtonTypeCenter, "Add",
                              nfc_scene_mf_classic_keys_widget_callback, instance);
