...
static void gpio_test_draw_callback(Canvas *canvas, void *_model)
{
    ...
    elements_multiline_text_aligned(canvas, 64, 16, AlignCenter, AlignTop,
                                    "Press < or > to change pin");
    elements_multiline_text_aligned(canvas, 64, 32, AlignCenter, AlignTop,
