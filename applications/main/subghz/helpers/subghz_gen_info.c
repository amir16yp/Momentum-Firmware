...
void subghz_scene_set_type_fill_generation_infos(GenInfo *infos_dest, SetType type)
{
    ...
    case SetTypeRoger_433:
        gen_info = (GenInfo){.type = GenData,
                             ...
                             .data.key = (key & 0xFFFF000) |
                                         0x0000101, // button code 0x1 and (crc?) is 0x01
                             .data.bits = 28,
                             .data.te = 0};
        break;
    ...
    case SetTypeMarantec24_868:
        gen_info = (GenInfo){.type = GenData,
                             ...
                             .freq = 868350000,
                             .data.name =
                                 SUBGHZ_PROTOCOL_MARANTEC24_NAME, // Add button code 0x8 to the end
    ...
    case SetTypeMarantec_433:
        gen_info = (GenInfo){
            ...
            .mod = "AM650",
            .freq = 433920000,
            .data.name = SUBGHZ_PROTOCOL_MARANTEC_NAME, // Button code is 0x4 and crc sum to the end
    ...
    case SetTypeBFTMitto:
        gen_info = (GenInfo){.type = GenKeeloqSeed,
                             .mod = "AM650",
                             .freq = 433920000,
    ...
    case SetTypeSomfyKeytis:
        gen_info = (GenInfo){.type = GenSomfyKeytis,
                             .mod = "AM650",
                             .freq = 433420000,
    ...
    case SetTypeKingGatesStylo4k:
        gen_info = (GenInfo){.type = GenKingGatesStylo4k,
                             .mod = "AM650",
                             .freq = 433920000,
    ...
    case SetTypeBenincaARC:
        gen_info = (GenInfo){.type = GenBenincaARC,
                             .mod = "AM650",
                             .freq = 433920000,
    ...
    case SetTypeJarolift:
        gen_info = (GenInfo){.type = GenJarolift,
                             .mod = "AM650",
                             .freq = 433920000,
    ...
    case SetTypeDitecGOL4:
        gen_info = (GenInfo){.type = GenDitecGOL4,
                             .mod = "AM650",
                             .freq = 433920000,
    ...
    case SetTypePhoenix_V2_433:
        gen_info = (GenInfo){.type = GenPhoenixV2,
                             .mod = "AM650",
                             .freq = 433920000,
