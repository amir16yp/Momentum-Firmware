...
void subghz_scene_start_on_enter(void *context)
{
    ...
    submenu_add_item(subghz->submenu, "Read", SubmenuIndexRead, subghz_scene_start_submenu_callback,
                     subghz);
    ...
    submenu_add_item(subghz->submenu, "Saved", SubmenuIndexSaved,
                     subghz_scene_start_submenu_callback, subghz);
    submenu_add_item(subghz->submenu, "Add Manually", SubmenuIndexAddManually,
                     subghz_scene_start_submenu_callback, subghz);
    submenu_add_item(subghz->submenu, "Add Manually [Advanced]", SubmenuIndexAddManuallyAdvanced,
                     subghz_scene_start_submenu_callback, subghz);
    submenu_add_item(subghz->submenu, "Frequency Analyzer", SubmenuIndexFrequencyAnalyzer,
                     subghz_scene_start_submenu_callback, subghz);
...
bool subghz_scene_start_on_event(void *context, SceneManagerEvent event)
{
    ...
    if (event.type == SceneManagerEventTypeBack) {
        ...
        if (event.event == SubmenuIndexReadRAW) {
            ...
            loader_enqueue_launch(loader, EXT_PATH("apps/assets/subghz_add_manually.fap"), arg,
                                  LoaderDeferredLaunchFlagGui);
            loader_enqueue_launch(loader, furi_string_get_cstr(self_path), arg,
                                  LoaderDeferredLaunchFlagGui);
