...
{
    SubGhz *subghz = context;
    submenu_add_item(subghz->submenu, "Emulate", SubmenuIndexEmulate,
                     subghz_scene_saved_menu_submenu_callback, subghz);
    ...
    if (!isnanf(subghz_txrx_get_latitude(subghz->txrx)) ||
        ...
        submenu_add_item(subghz->submenu, "Geographic info", SubmenuIndexGeo,
                         subghz_scene_saved_menu_submenu_callback, subghz);
    }

    submenu_add_lockable_item(subghz->submenu, "Signal Settings", SubmenuIndexSignalSettings,
                              subghz_scene_saved_menu_submenu_callback, subghz,
    ...
    submenu_set_selected_item(subghz->submenu, scene_manager_get_scene_state(subghz->scene_manager,
