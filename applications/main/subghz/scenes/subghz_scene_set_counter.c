...
void subghz_scene_set_counter_on_enter(void *context)
{
    ...
    byte_input_set_result_callback(byte_input, subghz_scene_set_counter_byte_input_callback, NULL,
        ...
        if (event.event == SubGhzCustomEventByteInputDone) {
            ...
            case GenKeeloq:
                generated_protocol = subghz_txrx_gen_keeloq_protocol(
                    ...
                    subghz->gen_info->keeloq.serial, subghz->gen_info->keeloq.btn,
                    subghz->gen_info->keeloq.cnt, subghz->gen_info->keeloq.manuf);
                break;
            case GenCameAtomo:
                generated_protocol = subghz_txrx_gen_came_atomo_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->came_atomo.serial, subghz->gen_info->came_atomo.cnt);
                break;
            case GenAlutechAt4n:
                generated_protocol = subghz_txrx_gen_alutech_at_4n_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->alutech_at_4n.serial, subghz->gen_info->alutech_at_4n.btn,
                    subghz->gen_info->alutech_at_4n.cnt);
                break;
            case GenSomfyTelis:
                generated_protocol = subghz_txrx_gen_somfy_telis_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->somfy_telis.serial, subghz->gen_info->somfy_telis.btn,
                    subghz->gen_info->somfy_telis.cnt);
                break;
            case GenSomfyKeytis:
                generated_protocol = subghz_txrx_gen_somfy_keytis_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->somfy_keytis.serial, subghz->gen_info->somfy_keytis.btn,
            ...
            case GenBenincaARC:
                generated_protocol = subghz_txrx_gen_beninca_arc_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->beninca_arc.serial, subghz->gen_info->beninca_arc.btn,
                    subghz->gen_info->beninca_arc.cnt);
                break;
            case GenJarolift:
                generated_protocol = subghz_txrx_gen_jarolift_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->jarolift.serial, subghz->gen_info->jarolift.btn,
                    subghz->gen_info->jarolift.cnt);
                break;
            case GenDitecGOL4:
                generated_protocol = subghz_txrx_gen_ditec_gol4_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->ditec_gol4.serial, subghz->gen_info->ditec_gol4.btn,
                    subghz->gen_info->ditec_gol4.cnt);
                break;
            case GenNiceFlorS:
                generated_protocol = subghz_txrx_gen_nice_flor_s_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->nice_flor_s.serial, subghz->gen_info->nice_flor_s.btn,
                    subghz->gen_info->nice_flor_s.cnt, subghz->gen_info->nice_flor_s.nice_one);
                break;
            case GenSecPlus2:
                generated_protocol = subghz_txrx_gen_secplus_v2_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->sec_plus_2.serial, subghz->gen_info->sec_plus_2.btn,
                    subghz->gen_info->sec_plus_2.cnt);
                break;
            case GenPhoenixV2:
                generated_protocol = subghz_txrx_gen_phoenix_v2_protocol(
                    subghz->txrx, subghz->gen_info->mod, subghz->gen_info->freq,
                    subghz->gen_info->phoenix_v2.serial, subghz->gen_info->phoenix_v2.cnt);
                break;
            // Not needed for these types
            case GenData:
            case GenSecPlus1:
