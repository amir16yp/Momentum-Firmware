...
bool subghz_scene_transmitter_update_data_show(void *context)
{
    ...
    if (decoder) {
        ...
        if (subghz_protocol_decoder_base_deserialize(
            ...
            subghz_view_transmitter_add_data_to_show(
                subghz->subghz_transmitter, furi_string_get_cstr(key_str),
                furi_string_get_cstr(frequency_str), furi_string_get_cstr(modulation_str),
    ...
    subghz_view_transmitter_set_radio_device_type(subghz->subghz_transmitter,
...
void subghz_scene_transmitter_on_enter(void *context)
{
    ...
    subghz_view_transmitter_set_callback(subghz->subghz_transmitter,
                                         subghz_scene_transmitter_callback, subghz);
