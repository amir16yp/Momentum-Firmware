...
void lfrfid_scene_write_and_set_pass_on_enter(void *context)
{
    ...
    lfrfid_worker_write_and_set_pass_start(app->lfworker, (LFRFIDProtocol)app->protocol_id,
                                           lfrfid_write_and_set_pass_callback, app);
