...
void lfrfid_scene_extra_actions_on_enter(void *context)
{
    ...
    submenu_add_item(submenu, "Read ASK (FDX,Regular)", SubmenuIndexASK,
                     lfrfid_scene_extra_actions_submenu_callback, app);
    submenu_add_item(submenu, "Read PSK (Indala)", SubmenuIndexPSK,
                     lfrfid_scene_extra_actions_submenu_callback, app);
    submenu_add_item(submenu, "Clear T5577 Password", SubmenuIndexClearT5577,
                     lfrfid_scene_extra_actions_submenu_callback, app);

    submenu_add_lockable_item(submenu, "Read RAW RFID data", SubmenuIndexRAW,
                              lfrfid_scene_extra_actions_submenu_callback, app,
                              ...
                              "System >\n"
                              "Debug");
    submenu_add_lockable_item(submenu, "Emulate RAW RFID data", SubmenuIndexRAWEmulate,
                              lfrfid_scene_extra_actions_submenu_callback, app,
                              !furi_hal_rtc_is_flag_set(FuriHalRtcFlagDebug),
                              "Enable\n"
                              "Settings >\n"
