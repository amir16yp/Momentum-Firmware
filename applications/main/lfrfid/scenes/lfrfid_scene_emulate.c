...
void lfrfid_scene_emulate_on_enter(void *context)
{
    ...
    furi_string_cat_printf(
        display_text, "[%s]\n%s", protocol_dict_get_name(app->dict, app->protocol_id),
    ...
    widget_add_text_box_element(widget, 51, 6, 79, 50, AlignCenter, AlignTop,
                                furi_string_get_cstr(display_text), false);
