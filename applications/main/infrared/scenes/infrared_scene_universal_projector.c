...
void infrared_scene_universal_projector_on_enter(void *context)
{
    ...
    button_panel_add_item(button_panel, i, 1, 0, 39, 24, &I_mute_19x20, &I_mute_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    ...
    button_panel_add_item(button_panel, i, 0, 1, 6, 58, &I_play_19x20, &I_play_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Play");
    button_panel_add_icon(button_panel, 6, 80, &I_play_text_19x5);
    button_panel_add_item(button_panel, i, 0, 2, 6, 87, &I_pause_19x20, &I_pause_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
