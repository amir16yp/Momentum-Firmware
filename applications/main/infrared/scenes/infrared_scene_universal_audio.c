...
void infrared_scene_universal_audio_on_enter(void *context)
{
    ...
    button_panel_add_item(button_panel, i, 1, 0, 39, 13, &I_mute_19x20, &I_mute_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    ...
    button_panel_add_item(button_panel, i, 0, 2, 6, 71, &I_pause_19x20, &I_pause_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    button_panel_add_icon(button_panel, 4, 93, &I_pause_text_23x5);
    infrared_brute_force_add_record(brute_force, i++, "Pause");
    button_panel_add_item(button_panel, i, 0, 3, 6, 101, &I_prev_19x20, &I_prev_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    button_panel_add_icon(button_panel, 6, 123, &I_prev_text_19x5);
    infrared_brute_force_add_record(brute_force, i++, "Prev");
    button_panel_add_item(button_panel, i, 1, 3, 39, 101, &I_next_19x20, &I_next_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    button_panel_add_icon(button_panel, 39, 123, &I_next_text_19x6);
    infrared_brute_force_add_record(brute_force, i++, "Next");
    button_panel_add_item(button_panel, i, 1, 2, 37, 77, &I_voldown_24x21, &I_voldown_hover_24x21,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Vol_dn");
    button_panel_add_item(button_panel, i, 1, 1, 37, 43, &I_volup_24x21, &I_volup_hover_24x21,
                          infrared_scene_universal_common_item_callback, context);
