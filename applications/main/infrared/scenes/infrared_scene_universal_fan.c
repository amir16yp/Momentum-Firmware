...
void infrared_scene_universal_fan_on_enter(void *context)
{
    ...
    uint32_t i = 0;
    button_panel_add_item(button_panel, i, 0, 0, 6, 24, &I_power_19x20, &I_power_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Power");
    button_panel_add_icon(button_panel, 4, 46, &I_power_text_24x5);

    button_panel_add_item(button_panel, i, 1, 0, 39, 24, &I_mode_19x20, &I_mode_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Mode");
    button_panel_add_icon(button_panel, 39, 46, &I_mode_text_20x5);

    button_panel_add_item(button_panel, i, 1, 1, 37, 55, &I_volup_24x21, &I_volup_hover_24x21,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Speed_up");
    button_panel_add_item(button_panel, i, 1, 2, 37, 89, &I_voldown_24x21, &I_voldown_hover_24x21,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Speed_dn");
    button_panel_add_item(button_panel, i, 0, 1, 6, 58, &I_rotate_19x20, &I_rotate_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    infrared_brute_force_add_record(brute_force, i++, "Rotate");
    button_panel_add_icon(button_panel, 4, 80, &I_rotate_text_24x5);

    button_panel_add_item(button_panel, i, 0, 2, 6, 87, &I_timer_19x20, &I_timer_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
