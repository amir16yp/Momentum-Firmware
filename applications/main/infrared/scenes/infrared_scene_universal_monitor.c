...
void infrared_scene_universal_monitor_on_enter(void *context)
{
    ...
    button_panel_add_item(button_panel, i, 1, 0, 38, 24, &I_input_19x20, &I_input_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    button_panel_add_icon(button_panel, 36, 46, &I_input_text_24x5);
    infrared_brute_force_add_record(brute_force, i++, "SOURCE");

    button_panel_add_item(button_panel, i, 0, 1, 6, 58, &I_mode_19x20, &I_mode_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
    button_panel_add_icon(button_panel, 6, 80, &I_menu_text_20x5);
    infrared_brute_force_add_record(brute_force, i++, "MENU");

    button_panel_add_item(button_panel, i, 1, 1, 38, 58, &I_exit_19x20, &I_exit_hover_19x20,
                          infrared_scene_universal_common_item_callback, context);
