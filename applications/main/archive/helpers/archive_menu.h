...
static void ArchiveContextMenuItem_t_init_set(ArchiveContextMenuItem_t *obj,
...
static void ArchiveContextMenuItem_t_set(ArchiveContextMenuItem_t *obj,
                                         const ArchiveContextMenuItem_t *src)
{
...
ARRAY_DEF(menu_array, ArchiveContextMenuItem_t,
          (INIT(API_2(ArchiveContextMenuItem_t_init)), SET(API_6(ArchiveContextMenuItem_t_set)),
...
static void archive_menu_add_item(ArchiveContextMenuItem_t *obj, const char *text, uint32_t event)
{
