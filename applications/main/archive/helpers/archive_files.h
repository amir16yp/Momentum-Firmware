...
#define M_OPL_ArchiveFile_t()                                                                      \
    (INIT(API_2(ArchiveFile_t_init)), SET(API_6(ArchiveFile_t_set)),                               \
     INIT_SET(API_6(ArchiveFile_t_init_set)), CLEAR(API_2(ArchiveFile_t_clear)),                   \
     CMP(API_6(ArchiveFile_t_cmp)), SWAP(M_SWAP_DEFAULT), EQUAL(API_6(M_EQUAL_DEFAULT)))
