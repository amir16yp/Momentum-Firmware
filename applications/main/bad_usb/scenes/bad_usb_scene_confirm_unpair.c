...
void bad_usb_scene_confirm_unpair_widget_callback(GuiButtonType type, InputType input_type,
                                                  void *context)
{
    UNUSED(input_type);
...
void bad_usb_scene_confirm_unpair_on_enter(void *context)
{
    ...
    widget_add_button_element(widget, GuiButtonTypeLeft, "Cancel",
                              bad_usb_scene_confirm_unpair_widget_callback, context);
    widget_add_button_element(widget, GuiButtonTypeRight, "Unpair",
                              bad_usb_scene_confirm_unpair_widget_callback, context);

    widget_add_text_box_element(widget, 0, 0, 128, 64, AlignCenter, AlignTop,
                                "\e#Unpair the Device?\e#\n", false);
