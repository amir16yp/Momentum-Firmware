...
static void storage_settings_scene_unmount_confirm_dialog_callback(DialogExResult result,
                                                                   void *context)
{
...
void storage_settings_scene_unmount_confirm_on_enter(void *context)
{
    ...
    if (sd_status == FSE_NOT_READY) {
        ...
        dialog_ex_set_text(dialog_ex, "This may turn off power\nfor external modules", 64, 32,
        ...
        dialog_ex_set_text(dialog_ex, "SD card will be\nunavailable", 64, 32, AlignCenter,
                           AlignCenter);
        dialog_ex_set_left_button_text(dialog_ex, "Cancel");
    ...
    dialog_ex_set_result_callback(dialog_ex,
                                  storage_settings_scene_unmount_confirm_dialog_callback);
