...
static void storage_settings_scene_factory_reset_dialog_callback(DialogExResult result,
                                                                 void *context)
{
...
void storage_settings_scene_factory_reset_on_enter(void *context)
{
    ...
    dialog_ex_set_text(dialog_ex,
                       "Internal storage will be erased\ndata and settings will be lost!", 64, 14,
    ...
    if (event.type == SceneManagerEventTypeCustom) {
        ...
        case DialogExResultRight:
            ...
            if (counter < STORAGE_SETTINGS_SCENE_FACTORY_RESET_CONFIRM_COUNT) {
                ...
                scene_manager_set_scene_state(app->scene_manager, StorageSettingsFactoryReset,
                                              counter);
            } else {
