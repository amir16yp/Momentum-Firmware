...
static void storage_settings_scene_format_confirm_dialog_callback(DialogExResult result,
                                                                  void *context)
{
...
void storage_settings_scene_format_confirm_on_enter(void *context)
{
    ...
    dialog_ex_set_result_callback(dialog_ex, storage_settings_scene_format_confirm_dialog_callback);
