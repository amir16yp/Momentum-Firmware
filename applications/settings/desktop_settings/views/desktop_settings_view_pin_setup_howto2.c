...
static void desktop_settings_view_pin_setup_howto2_draw(Canvas *canvas, void *model)
{
    ...
    elements_multiline_text_aligned(canvas, 64, 0, AlignCenter, AlignTop,
...
void desktop_settings_view_pin_setup_howto2_set_context(DesktopSettingsViewPinSetupHowto2 *instance,
                                                        void *context)
{
...
void desktop_settings_view_pin_setup_howto2_set_cancel_callback(
    DesktopSettingsViewPinSetupHowto2 *instance, DesktopSettingsViewPinSetupHowto2Callback callback)
{
    furi_assert(instance);
