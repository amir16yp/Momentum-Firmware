...
void desktop_settings_scene_pin_auth_on_enter(void *context)
{
    ...
    desktop_view_pin_input_set_label_secondary(app->pin_input_view, 0, 8,
...
bool desktop_settings_scene_pin_auth_on_event(void *context, SceneManagerEvent event)
{
    ...
    if (event.type == SceneManagerEventTypeCustom) {
        ...
        case DesktopSettingsCustomEventPinsDifferent:
            scene_manager_set_scene_state(app->scene_manager, DesktopSettingsAppScenePinError,
                                          SCENE_STATE_PIN_ERROR_WRONG);
        ...
        case DesktopSettingsCustomEventExit:
            scene_manager_search_and_switch_to_previous_scene(app->scene_manager,
                                                              DesktopSettingsAppScenePinMenu);
            consumed = true;
            break;
