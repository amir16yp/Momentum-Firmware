...
void desktop_settings_scene_keybinds_key_on_enter(void *context)
{
    ...
    submenu_add_item(submenu, "Up", DesktopKeybindKeyUp,
                     desktop_settings_scene_keybinds_key_submenu_callback, app);

    submenu_add_item(submenu, "Down", DesktopKeybindKeyDown,
                     desktop_settings_scene_keybinds_key_submenu_callback, app);

    submenu_add_item(submenu, "Right", DesktopKeybindKeyRight,
                     desktop_settings_scene_keybinds_key_submenu_callback, app);

    submenu_add_item(submenu, "Left", DesktopKeybindKeyLeft,
                     desktop_settings_scene_keybinds_key_submenu_callback, app);

    submenu_set_header(submenu, "Keybind key:");

    submenu_set_selected_item(submenu, scene_manager_get_scene_state(
                                           app->scene_manager, DesktopSettingsAppSceneKeybindsKey));
...
bool desktop_settings_scene_keybinds_key_on_event(void *context, SceneManagerEvent event)
{
    ...
    if (event.type == SceneManagerEventTypeCustom) {
        consumed = true;
        scene_manager_set_scene_state(app->scene_manager, DesktopSettingsAppSceneKeybindsKey,
                                      event.event);
