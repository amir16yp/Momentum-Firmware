...
static void desktop_settings_scene_keybinds_reset_dialog_callback(DialogExResult result,
                                                                  void *context)
{
...
void desktop_settings_scene_keybinds_reset_on_enter(void *context)
{
    ...
    dialog_ex_set_result_callback(dialog_ex, desktop_settings_scene_keybinds_reset_dialog_callback);
