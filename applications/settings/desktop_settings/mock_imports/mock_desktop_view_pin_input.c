...
// desktop_view_pin_input_set_context(), desktop_view_pin_input_set_label_button(),
// desktop_view_pin_input_unlock_input(), desktop_view_pin_input_set_pin_position(),
// desktop_view_pin_input_set_label_primary(), desktop_view_pin_input_reset_pin(),
// desktop_view_pin_input_set_done_callback(), desktop_view_pin_input_lock_input(),
// desktop_view_pin_input_alloc(), desktop_view_pin_input_free()
