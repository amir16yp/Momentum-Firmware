...
static void draw_battery(Canvas *canvas, BatteryInfoModel *data, int x, int y)
{
    ...
    if (charge_current > 0) {
        ...
        snprintf(value, sizeof(value), "%lu.%luV", (uint32_t)(data->charging_voltage),
