...
static constexpr auto unit_tests_api_table = sort(create_array_t<sym_entry>(
    ...
    API_METHOD(resource_manifest_reader_previous, ResourceManifestEntry *,
               (ResourceManifestReader *)),
    ...
    API_METHOD(xTaskGenericNotify, BaseType_t,
    ...
    API_METHOD(js_value_parse, JsValueParseStatus,
               (struct mjs * mjs, const JsValueParseDeclaration declaration, JsValueParseFlag flags,
                mjs_val_t *buffer, size_t buf_size, mjs_val_t *source, size_t n_c_vals, ...)),
