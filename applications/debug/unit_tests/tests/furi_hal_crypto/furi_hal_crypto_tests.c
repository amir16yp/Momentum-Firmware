...
static const uint8_t iv_gcm_3[16] = {
    0xCA, 0xFE, 0xBA, 0xBE, 0xFA, 0xCE, 0xDB, 0xAD, 0xDE, 0xCA, 0xF8, 0x88, 0x00, 0x00, 0x00, 0x00,
};
...
MU_TEST(furi_hal_crypto_gcm_1)
{
    ...
    ret = furi_hal_crypto_gcm(key_gcm_1, iv_gcm_1, aad_gcm_1, sizeof(aad_gcm_1), pt_gcm_1, ct,
                              sizeof(pt_gcm_1), tag_enc, false);
    ...
    ret = furi_hal_crypto_gcm(key_gcm_1, iv_gcm_1, aad_gcm_1, sizeof(aad_gcm_1), ct, pt,
                              sizeof(pt_gcm_1), tag_dec, true);
...
MU_TEST(furi_hal_crypto_gcm_2)
{
    ...
    ret = furi_hal_crypto_gcm(key_gcm_2, iv_gcm_2, aad_gcm_2, sizeof(aad_gcm_2), pt_gcm_2, ct,
                              sizeof(pt_gcm_2), tag_enc, false);
    ...
    ret = furi_hal_crypto_gcm(key_gcm_2, iv_gcm_2, aad_gcm_2, sizeof(aad_gcm_2), ct, pt,
                              sizeof(pt_gcm_2), tag_dec, true);
...
MU_TEST(furi_hal_crypto_gcm_3)
{
    ...
    ret = furi_hal_crypto_gcm(key_gcm_3, iv_gcm_3, aad_gcm_3, sizeof(aad_gcm_3), pt_gcm_3, ct,
                              sizeof(pt_gcm_3), tag_enc, false);
    ...
    ret = furi_hal_crypto_gcm(key_gcm_3, iv_gcm_3, aad_gcm_3, sizeof(aad_gcm_3), ct, pt,
                              sizeof(pt_gcm_3), tag_dec, true);
...
MU_TEST(furi_hal_crypto_gcm_4)
{
    ...
    ret = furi_hal_crypto_gcm(key_gcm_4, iv_gcm_4, aad_gcm_4, sizeof(aad_gcm_4), pt_gcm_4, ct,
                              sizeof(pt_gcm_4), tag_enc, false);
    ...
    ret = furi_hal_crypto_gcm(key_gcm_4, iv_gcm_4, aad_gcm_4, sizeof(aad_gcm_4), ct, pt,
                              sizeof(pt_gcm_4), tag_dec, true);
