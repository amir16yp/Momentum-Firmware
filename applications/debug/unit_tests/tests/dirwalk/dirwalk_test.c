...
static const char *const storage_test_dirwalk_paths[] = {
    "1", "11", "111", "1/2", "1/22", "1/222", "11/2", "111/2", "111/22", "111/22/33",
};
...
const StorageTestPathDesc storage_test_dirwalk_no_recursive[] = {
    {.path = "1", .is_dir = true},           {.path = "11", .is_dir = true},
    {.path = "111", .is_dir = true},         {.path = "file1.test", .is_dir = false},
    {.path = "file2.test", .is_dir = false}, {.path = "file3.ext_test", .is_dir = false},
};
...
static StorageTestPathDict_t *storage_test_paths_alloc(const StorageTestPathDesc paths[],
                                                       size_t paths_count)
{
...
MU_TEST_1(test_dirwalk_filter, Storage *storage)
{
    ...
    StorageTestPathDict_t *paths = storage_test_paths_alloc(storage_test_dirwalk_filter,
                                                            COUNT_OF(storage_test_dirwalk_filter));
