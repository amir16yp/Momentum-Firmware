...
static void subghz_test_rx_callback(SubGhzReceiver *receiver,
                                    SubGhzProtocolDecoderBase *decoder_base, void *context)
{
    UNUSED(receiver);
    UNUSED(context);
    FuriString *text;
...
static void subghz_test_init(void)
{
    ...
    subghz_environment_set_nice_flor_s_rainbow_table_file_name(environment_handler,
                                                               NICE_FLOR_S_DIR_NAME);
    subghz_environment_set_alutech_at_4n_rainbow_table_file_name(environment_handler,
                                                                 ALUTECH_AT_4N_DIR_NAME);
    subghz_environment_set_protocol_registry(environment_handler,
...
{
    mu_assert(subghz_environment_load_keystore(environment_handler, KEYSTORE_DIR_NAME),
              "Test keystore error");
}
...
{
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeNormal),
              "Test furi_hal_async_tx normal");
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeInvalidStart),
              "Test furi_hal_async_tx invalid start");
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeInvalidMid),
              "Test furi_hal_async_tx invalid mid");
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeInvalidEnd),
              "Test furi_hal_async_tx invalid end");
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeResetStart),
              "Test furi_hal_async_tx reset start");
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeResetMid),
              "Test furi_hal_async_tx reset mid");
    mu_assert(subghz_hal_async_tx_test_run(SubGhzHalAsyncTxTestTypeResetEnd),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/came_atomo_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/came_twee_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/faac_slh_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/gate_tx_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/hormann_hsm_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/ido_117_111_raw.sub"),
                                  SUBGHZ_PROTOCOL_IDO_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_IDO_NAME " error\r\n");
}

MU_TEST(subghz_decoder_keeloq_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/doorhan_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/nero_radio_raw.sub"),
                                  SUBGHZ_PROTOCOL_NERO_RADIO_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_NERO_RADIO_NAME " error\r\n");
}

MU_TEST(subghz_decoder_nero_sketch_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/nero_sketch_raw.sub"),
                                  SUBGHZ_PROTOCOL_NERO_SKETCH_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_NERO_SKETCH_NAME " error\r\n");
}

MU_TEST(subghz_decoder_nice_flo_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/nice_flo_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/nice_flor_s_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/Princeton_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/Somfy_keytis_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/somfy_telis_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/linear_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/linear_delta3_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/megacode_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/security_pls_1_0_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/security_pls_2_0_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/holtek_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/power_smart_raw.sub"),
                                  SUBGHZ_PROTOCOL_POWER_SMART_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_POWER_SMART_NAME " error\r\n");
}

MU_TEST(subghz_decoder_marantec_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/marantec_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/doitrand_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/phoenix_v2_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/honeywell_wdb_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/magellan_raw.sub"),
                                  SUBGHZ_PROTOCOL_MAGELLAN_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_MAGELLAN_NAME " error\r\n");
}

MU_TEST(subghz_decoder_intertechno_v3_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/intertechno_v3_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/clemsa_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/ansonic_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/smc5326_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/holtek_ht12x_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/dooya_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/alutech_at_4n_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/nice_one_raw.sub"),
                                  SUBGHZ_PROTOCOL_NICE_FLOR_S_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_NICE_FLOR_S_NAME " error\r\n");
}
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/kinggates_stylo4k_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/mastercode_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/dickert_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/legrand_raw.sub"),
                                  SUBGHZ_PROTOCOL_LEGRAND_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_LEGRAND_NAME " error\r\n");
}

MU_TEST(subghz_decoder_marantec24_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/marantec24_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/roger_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/feron_raw.sub"),
                                  SUBGHZ_PROTOCOL_FERON_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_FERON_NAME " error\r\n");
}

MU_TEST(subghz_decoder_gangqi_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/gangqi_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/hollarm_raw.sub"),
                                  SUBGHZ_PROTOCOL_HOLLARM_NAME),
              "Test decoder " SUBGHZ_PROTOCOL_HOLLARM_NAME " error\r\n");
}

MU_TEST(subghz_decoder_reversrb2_test)
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/revers_rb2_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/hay21_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/solight_te44_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/bresser_3ch_raw.sub"),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/bresser_3ch_v0_raw.sub"),
                                  WS_PROTOCOL_BRESSER_3CH_NAME),
...
{
    mu_assert(subghz_decoder_test(EXT_PATH("unit_tests/subghz/vauno_en8822c.sub"),
                                  WS_PROTOCOL_VAUNO_EN8822C_NAME),
