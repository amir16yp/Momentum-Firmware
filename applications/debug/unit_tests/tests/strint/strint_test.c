...
MU_TEST(strint_test_junk)
{
    ...
    mu_assert_int_eq(StrintParseNoError, strint_to_uint32("   123456   ", NULL, &result, 10));
    mu_assert_int_eq(123456, result);
    mu_assert_int_eq(StrintParseNoError,
...
MU_TEST(strint_test_errors)
{
    ...
    mu_assert_int_eq(123, result);
    mu_assert_int_eq(StrintParseOverflowError,
    ...
    mu_assert_int_eq(StrintParseOverflowError,
                     strint_to_int32("-2147483649", NULL, &result_i32, 0));
...
MU_TEST_SUITE(strint_test_limits)
{
    ...
    mu_assert_int_eq(StrintParseNoError,
                     strint_to_uint64("18446744073709551615", NULL, &result_u64, 0));
    ...
    mu_assert_int_eq(StrintParseNoError,
                     strint_to_int64("9223372036854775807", NULL, &result_i64, 0));
    mu_assert(INT64_MAX == result_i64, "result does not equal INT64_MAX");
    mu_assert_int_eq(StrintParseNoError,
                     strint_to_int64("-9223372036854775808", NULL, &result_i64, 0));
