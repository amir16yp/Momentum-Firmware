...
static const TextBoxViewTestContent text_box_view_test_content_arr[] = {
    ...
    },
    {
        ...
        .focus = TextBoxFocusStart,
        .text =
            "Verify that symbols don't overlap borders: "
            "llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll"
            "llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll"
            "llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllend",
    },
    {
        .font = TextBoxFontText,
        .focus = TextBoxFocusStart,
        .text = "\n\n\n Start from several newline chars. Verify that scrolling doesn't "
                "break.\n\n\n\n\nThe end",
    },
    {
        .font = TextBoxFontText,
        ...
        .text =
            ...
            "cores licensed by ARM Limited. These cores are optimized for low-cost and "
            "energy-efficient integrated circuits, which have been embedded in tens of billions of "
            "consumer devices.[1] Though they are most often the main component of microcontroller "
            "chips, sometimes they are embedded inside other types of chips too. The Cortex-M "
            "family consists of Cortex-M0,[2] Cortex-M0+,[3] Cortex-M1,[4] Cortex-M3,[5] "
            "Cortex-M4,[6] Cortex-M7,[7] Cortex-M23,[8] Cortex-M33,[9] Cortex-M35P,[10] "
            "Cortex-M52,[11] Cortex-M55,[12] Cortex-M85.[13] A floating-point unit (FPU) option is "
            "available for Cortex-M4 / M7 / M33 / M35P / M52 / M55 / M85 cores, and when included "
            "in the silicon these cores are sometimes known as \"Cortex-MxF\", where 'x' is the "
            "core variant.\n\nThe ARM Cortex-M family are ARM microprocessor cores that are "
            "designed for use in microcontrollers, ASICs, ASSPs, FPGAs, and SoCs. Cortex-M cores "
            "are commonly used as dedicated microcontroller chips, but also are hidden inside of "
            "SoC chips as power management controllers, I/O controllers, system controllers, touch "
            "screen controllers, smart battery controllers, and sensor controllers. The main "
            "difference from Cortex-A cores is that Cortex-M cores have no memory management unit "
            "(MMU) for virtual memory, considered essential for full-fledged operating systems. "
            "Cortex-M programs instead run bare metal or on one of the many real-time operating "
            "systems which support a Cortex-M.Though 8-bit microcontrollers were very popular in "
            "the past, Cortex-M has slowly been chipping away at the 8-bit market as the prices of "
            "low-end Cortex-M chips have moved downward. Cortex-M have become a popular "
            "replacements for 8-bit chips in applications that benefit from 32-bit math "
    ...
    },
    {
        ...
        .text =
            ...
            "processor cores licensed by ARM Limited. These cores are optimized for low-cost and "
            "energy-efficient integrated circuits, which have been embedded in tens of billions of "
            "consumer devices.[1] Though they are most often the main component of microcontroller "
            "chips, sometimes they are embedded inside other types of chips too. The Cortex-M "
            "family consists of Cortex-M0,[2] Cortex-M0+,[3] Cortex-M1,[4] Cortex-M3,[5] "
