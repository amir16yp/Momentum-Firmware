...
void subghz_test_scene_about_on_enter(void *context)
{
    ...
    furi_string_cat_printf(temp_str, "This application is designed\nto test the functionality of "
                                     "the\nbuilt-in CC1101 module.\n\n");

    widget_add_text_box_element(app->widget, 0, 0, 128, 14, AlignCenter, AlignBottom,
                                "\e#\e!                                                      \e!\n",
                                false);
    widget_add_text_box_element(app->widget, 0, 2, 128, 14, AlignCenter, AlignBottom,
                                "\e#\e!         Sub-Ghz Test          \e!\n", false);
