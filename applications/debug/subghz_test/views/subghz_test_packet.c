...
void subghz_test_packet_set_callback(SubGhzTestPacket *subghz_test_packet,
                                     SubGhzTestPacketCallback callback, void *context)
{
    ...
    with_view_model(
        instance->view, SubGhzTestPacketModel * model,
        {
            ...
            if (model->status == SubGhzTestPacketModelStatusRx) {
                ...
                if (!furi_hal_subghz_start_async_tx(subghz_encoder_princeton_for_testing_yield,
                                                    instance->encoder)) {
...
SubGhzTestPacket *subghz_test_packet_alloc(void)
{
    ...
    subghz_decoder_princeton_for_testing_set_callback(instance->decoder,
                                                      subghz_test_packet_rx_pt_callback, instance);
