...
void rpc_debug_app_scene_start_on_enter(void *context)
{
    ...
    submenu_add_item(submenu, "Test App Error", SubmenuIndexTestAppError,
                     rpc_debug_app_scene_start_submenu_callback, app);
    submenu_add_item(submenu, "Test Data Exchange", SubmenuIndexTestDataExchange,
                     rpc_debug_app_scene_start_submenu_callback, app);
