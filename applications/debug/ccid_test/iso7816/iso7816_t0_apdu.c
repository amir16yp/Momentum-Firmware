...
// reads pc_to_reader_datablock_len with pc_to_reader_datablock_len size, translate it into a
// ISO7816_Command_APDU type extra data will be pointed to commandDataBuffer
uint8_t iso7816_read_command_apdu(ISO7816_Command_APDU *command,
                                  const uint8_t *pc_to_reader_datablock,
                                  uint32_t pc_to_reader_datablock_len, uint32_t max_apdu_size)
{
...
void iso7816_write_response_apdu(const ISO7816_Response_APDU *response,
