...
static bool text_assign(struct mjs *mjs, TextBox *text_box, JsViewPropValue value,
                        FuriString *context)
{
    UNUSED(mjs);
...
static bool focus_assign(struct mjs *mjs, TextBox *text_box, JsViewPropValue value, void *context)
{
    UNUSED(context);
    TextBoxFocus focus;
...
static const JsViewDescriptor view_descriptor = {
    ...
    .props = {
        ...
        (JsViewPropDescriptor){
            .name = "font", .type = JsViewPropTypeString, .assign = (JsViewPropAssign)font_assign},
