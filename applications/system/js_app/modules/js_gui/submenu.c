...
static bool header_assign(struct mjs *mjs, Submenu *submenu, JsViewPropValue value, void *context)
{
    UNUSED(mjs);
    UNUSED(context);
...
static bool js_submenu_add_child(struct mjs *mjs, Submenu *submenu, JsSubmenuCtx *context,
                                 mjs_val_t child_obj)
{
