...
static mjs_val_t input_transformer(struct mjs *mjs, FuriMessageQueue *queue, JsDialogCtx *context)
{
    UNUSED(context);
...
static bool header_assign(struct mjs *mjs, DialogEx *dialog, JsViewPropValue value,
                          JsDialogCtx *context)
{
    UNUSED(mjs);
    UNUSED(context);
...
static bool text_assign(struct mjs *mjs, DialogEx *dialog, JsViewPropValue value,
                        JsDialogCtx *context)
{
    UNUSED(mjs);
    UNUSED(context);
...
static bool left_assign(struct mjs *mjs, DialogEx *dialog, JsViewPropValue value,
                        JsDialogCtx *context)
{
    UNUSED(mjs);
    UNUSED(context);
...
static bool center_assign(struct mjs *mjs, DialogEx *dialog, JsViewPropValue value,
                          JsDialogCtx *context)
{
    UNUSED(mjs);
    UNUSED(context);
...
static bool right_assign(struct mjs *mjs, DialogEx *dialog, JsViewPropValue value,
                         JsDialogCtx *context)
{
    UNUSED(mjs);
    UNUSED(context);
...
static const JsViewDescriptor view_descriptor = {
    ...
    .props = {
        ...
        (JsViewPropDescriptor){
            .name = "left", .type = JsViewPropTypeString, .assign = (JsViewPropAssign)left_assign},
