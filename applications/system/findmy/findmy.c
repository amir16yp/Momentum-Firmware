...
static FindMy *findmy_app_alloc()
{
    ...
    view_dispatcher_set_navigation_event_callback(app->view_dispatcher, findmy_back_event_callback);

    app->findmy_main = findmy_main_alloc(app);
    view_dispatcher_add_view(app->view_dispatcher, FindMyViewMain,
                             findmy_main_get_view(app->findmy_main));

    app->byte_input = byte_input_alloc();
    view_dispatcher_add_view(app->view_dispatcher, FindMyViewByteInput,
                             byte_input_get_view(app->byte_input));

    app->var_item_list = variable_item_list_alloc();
    view_dispatcher_add_view(app->view_dispatcher, FindMyViewVarItemList,
