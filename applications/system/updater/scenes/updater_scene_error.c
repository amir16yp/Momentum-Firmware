...
void updater_scene_error_on_enter(void *context)
{
    ...
    widget_add_button_element(updater->widget, GuiButtonTypeLeft, "Exit",
                              updater_scene_error_callback, updater);

    widget_add_string_multiline_element(updater->widget, 64, 13, AlignCenter, AlignCenter,
                                        FontPrimary, "Error");

    widget_add_string_multiline_element(
        updater->widget, 64, 33, AlignCenter, AlignCenter, FontPrimary,
