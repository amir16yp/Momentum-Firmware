...
typedef enum {
    ...
    FuriStatusErrorNoMemory = -5,  ///< System is out of memory: it was impossible to allocate or
                                   ///< reserve memory for the operation.
    FuriStatusErrorISR = -6, ///< Not allowed in ISR context: the function cannot be called from
