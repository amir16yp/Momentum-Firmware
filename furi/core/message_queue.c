...
FuriMessageQueue *furi_message_queue_alloc(uint32_t msg_count, uint32_t msg_size)
{
    ...
    //
    // As a bonus it guarantees that FuriMessageQueue* can be casted into StaticQueue_t* or
    // QueueHandle_t.
    furi_check(xQueueCreateStatic(msg_count, msg_size, instance->buffer, &instance->container) ==
               (void *)instance);
...
static bool furi_message_queue_event_loop_get_level(FuriEventLoopObject *object,
