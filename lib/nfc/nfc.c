                                                ...
                                                BitBuffer *rx_buffer, uint32_t fwt)
{
    ...
    do {
        ...
        bit_buffer_write_bytes_with_parity(tx_buffer, instance->tx_buffer,
                                           sizeof(instance->tx_buffer), &instance->tx_bits);
        error =
        ...
        error = furi_hal_nfc_poller_rx(instance->rx_buffer, sizeof(instance->rx_buffer),
                                       &instance->rx_bits);
        if (error != FuriHalNfcErrorNone) {
...
void nfc_felica_listener_timer_anticol_start(Nfc *instance, uint8_t target_time_slot)
{
    ...
    furi_hal_nfc_timer_block_tx_start(NFC_FELICA_LISTENER_RESPONSE_TIME_A_FC +
