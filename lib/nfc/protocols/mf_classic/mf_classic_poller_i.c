...
static MfClassicError mf_classic_poller_get_nt_common(MfClassicPoller *instance, uint8_t block_num,
                                                      MfClassicKeyType key_type, MfClassicNt *nt,
                                                      bool is_nested, bool backdoor_auth)
{
    MfClassicError ret = MfClassicErrorNone;
    ...
    do {
        ...
        if (is_nested) {
            ...
            error = iso14443_3a_poller_txrx_custom_parity(
                instance->iso14443_3a_poller, instance->tx_encrypted_buffer,
            ...
            error = iso14443_3a_poller_send_standard_frame(
                instance->iso14443_3a_poller, instance->tx_plain_buffer, instance->rx_plain_buffer,
                MF_CLASSIC_FWT_FC);
                                        ...
                                        bool backdoor_auth)
{
    ...
    return mf_classic_poller_get_nt_common(instance, block_num, key_type, nt, false, backdoor_auth);
}
...
MfClassicError mf_classic_poller_auth_common(MfClassicPoller *instance, uint8_t block_num,
                                             MfClassicKey *key, MfClassicKeyType key_type,
                                             MfClassicAuthContext *data, bool is_nested,
                                             bool backdoor_auth, bool early_ret)
{
    MfClassicError ret = MfClassicErrorNone;
    Iso14443_3aError error = Iso14443_3aErrorNone;
    ...
    do {
        ...
        crypto1_encrypt_reader_nonce(instance->crypto, key_num, cuid, nt.data, nr.data,
                                     instance->tx_encrypted_buffer, is_nested);
        error = iso14443_3a_poller_txrx_custom_parity(
            instance->iso14443_3a_poller, instance->tx_encrypted_buffer,
            instance->rx_encrypted_buffer, MF_CLASSIC_FWT_FC);
        ...
        if (data) {
            ...
            bit_buffer_write_bytes(instance->rx_encrypted_buffer, data->at.data,
                                   sizeof(MfClassicAt));
        }
    } while (false);
                                            ...
                                            MfClassicBlock *data)
{
    ...
    do {
        ...
        crypto1_decrypt(instance->crypto, instance->rx_encrypted_buffer, instance->rx_plain_buffer);
                                                     ...
                                                     BitBuffer *rx_buffer, uint32_t fwt_fc)
{
    ...
    Iso14443_3aError error = iso14443_3a_poller_send_standard_frame(instance->iso14443_3a_poller,
                                                                    tx_buffer, rx_buffer, fwt_fc);
                                                          ...
                                                          BitBuffer *rx_buffer, uint32_t fwt_fc)
{
    ...
    Iso14443_3aError error = iso14443_3a_poller_txrx_custom_parity(instance->iso14443_3a_poller,
                                                                   tx_buffer, rx_buffer, fwt_fc);
                                                      ...
                                                      BitBuffer *rx_buffer, uint32_t fwt_fc)
{
    ...
    do {
        ...
        Iso14443_3aError error = iso14443_3a_poller_txrx_custom_parity(
            instance->iso14443_3a_poller, instance->tx_encrypted_buffer,
            instance->rx_encrypted_buffer, fwt_fc);
        if (error != Iso14443_3aErrorNone) {
            ret = mf_classic_process_error(error);
            break;
        }
