...
typedef SlixError (*SlixRequestHandler)(SlixListener *instance, const uint8_t *data,
                                        size_t data_size, uint8_t flags);

// Helper functions

static bool slix_listener_is_password_lock_enabled(SlixListener *instance,
...
static SlixPassword slix_listener_unxor_password(const SlixPassword password_xored, uint16_t random)
{
    return REVERSE_BYTES_U32(password_xored ^ ((SlixPassword)random << 16 | random));
}

static SlixError slix_listener_set_password(SlixListener *instance, SlixPasswordType password_type,
...
static SlixError slix_listener_write_password(SlixListener *instance,
                                              SlixPasswordType password_type, SlixPassword password)
{
    SlixError error = SlixErrorNone;
...
static SlixError slix_listener_default_handler(SlixListener *instance, const uint8_t *data,
                                               size_t data_size, uint8_t flags)
{
    UNUSED(instance);
    UNUSED(data);
...
static SlixError slix_listener_get_nxp_system_info_handler(SlixListener *instance,
...
static SlixError slix_listener_get_random_number_handler(SlixListener *instance,
                                                         const uint8_t *data, size_t data_size,
                                                         uint8_t flags)
{
    UNUSED(data);
    ...
    bit_buffer_append_bytes(instance->tx_buffer, (uint8_t *)&session_state->random,
                            sizeof(uint16_t));

    return SlixErrorNone;
}

static SlixError slix_listener_set_password_handler(SlixListener *instance, const uint8_t *data,
                                                    size_t data_size, uint8_t flags)
{
    UNUSED(flags);
    SlixError error = SlixErrorNone;
...
static SlixError slix_listener_write_password_handler(SlixListener *instance, const uint8_t *data,
                                                      size_t data_size, uint8_t flags)
{
    UNUSED(flags);
    SlixError error = SlixErrorNone;
...
static SlixError slix_listener_protect_page_handler(SlixListener *instance, const uint8_t *data,
                                                    size_t data_size, uint8_t flags)
{
    UNUSED(flags);
    SlixError error = SlixErrorNone;
...
static SlixError slix_listener_enable_privacy_handler(SlixListener *instance, const uint8_t *data,
                                                      size_t data_size, uint8_t flags)
{
    UNUSED(flags);
    SlixError error = SlixErrorNone;
...
static SlixError slix_listener_read_signature_handler(SlixListener *instance, const uint8_t *data,
                                                      size_t data_size, uint8_t flags)
{
    UNUSED(data);
    UNUSED(data_size);
...
static Iso15693_3Error slix_listener_iso15693_3_inventory_extension_handler(SlixListener *instance,
                                                                            va_list args)
{
    UNUSED(args);
...
static Iso15693_3Error slix_iso15693_3_read_block_extension_handler(SlixListener *instance,
                                                                    va_list args)
{
...
static Iso15693_3Error slix_listener_iso15693_3_lock_block_extension_handler(SlixListener *instance,
                                                                             va_list args)
{
    Iso15693_3Error error = Iso15693_3ErrorNone;
...
static Iso15693_3Error
slix_listener_iso15693_3_read_multi_block_extension_handler(SlixListener *instance, va_list args)
{
    Iso15693_3Error error = Iso15693_3ErrorNone;
...
static Iso15693_3Error
slix_listener_iso15693_3_write_multi_block_extension_handler(SlixListener *instance, va_list args)
{
    UNUSED(instance);
    UNUSED(args);
...
static Iso15693_3Error
slix_listener_iso15693_3_write_lock_afi_extension_handler(SlixListener *instance, va_list args)
{
    UNUSED(args);
...
SlixError slix_listener_process_request(SlixListener *instance, const BitBuffer *rx_buffer)
{
    ...
    do {
        ...
        const bool is_valid_slix_command =
            command >= SLIX_CMD_CUSTOM_START && command < SLIX_CMD_CUSTOM_END;
