...
static Iso14443_3bError iso14443_3b_poller_frame_exchange(Iso14443_3bPoller *instance,
...
Iso14443_3bError iso14443_3b_poller_activate(Iso14443_3bPoller *instance, Iso14443_3bData *data)
{
    ...
    do {
        ...
        ret = iso14443_3b_poller_frame_exchange(instance, instance->tx_buffer, instance->rx_buffer,
                                                ISO14443_3B_FDT_POLL_FC);
        ...
        ret = iso14443_3b_poller_frame_exchange(instance, instance->tx_buffer, instance->rx_buffer,
                                                iso14443_3b_get_fwt_fc_max(data));
        if (ret != Iso14443_3bErrorNone) {
        ...
        if (bit_buffer_get_size_bytes(instance->rx_buffer) != 1) {
            FURI_LOG_W(TAG, "Unexpected ATTRIB response length: %zu",
                                               ...
                                               const BitBuffer *tx_buffer, BitBuffer *rx_buffer)
{
    ...
    do {
        ...
        ret = iso14443_3b_poller_frame_exchange(instance, tx_buffer, rx_buffer,
                                                iso14443_3b_get_fwt_fc_max(instance->data));
    } while (false);
