...
typedef Type4TagError (*Type4TagListenerApduHandler)(Type4TagListener *instance, uint8_t p1,
                                                     uint8_t p2, size_t lc, const uint8_t *data,
                                                     size_t le);
...
static Type4TagError type_4_tag_listener_iso_select(Type4TagListener *instance, uint8_t p1,
                                                    uint8_t p2, size_t lc, const uint8_t *data,
                                                    size_t le)
{
    UNUSED(p2);
    ...
    if (p1 == TYPE_4_TAG_ISO_SELECT_P1_BY_NAME && lc == TYPE_4_TAG_ISO_NAME_LEN) {
        if (memcmp(type_4_tag_iso_mf_name, data, sizeof(type_4_tag_iso_mf_name)) == 0) {
            ...
            bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_success_apdu,
                                    sizeof(type_4_tag_success_apdu));
    ...
    } else if ((p1 == TYPE_4_TAG_ISO_SELECT_P1_BY_ID || p1 == TYPE_4_TAG_ISO_SELECT_P1_BY_EF_ID) &&
    ...
    bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_not_found_apdu,
                            sizeof(type_4_tag_not_found_apdu));
    return Type4TagErrorCustomCommand;
}

static Type4TagError type_4_tag_listener_iso_read(Type4TagListener *instance, uint8_t p1,
                                                  uint8_t p2, size_t lc, const uint8_t *data,
                                                  size_t le)
{
    UNUSED(lc);
    ...
    if (p1 & TYPE_4_TAG_ISO_READ_P1_ID_MASK) {
        bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_no_support_apdu,
                                sizeof(type_4_tag_no_support_apdu));
        return Type4TagErrorCustomCommand;
    } else {
        offset = (p1 << 8) + p2;
    }
    ...
    if (instance->state == Type4TagListenerStateSelectedCapabilityContainer) {
        ...
        bit_buffer_append_bytes(instance->tx_buffer, cc_buf + offset,
                                MIN(sizeof(cc_buf) - offset, le));
        bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_success_apdu,
                                sizeof(type_4_tag_success_apdu));
        return Type4TagErrorNone;
    }
    ...
    if (instance->state == Type4TagListenerStateSelectedNdefMessage) {
        ...
        bit_buffer_append_bytes(instance->tx_buffer, &ndef_data[offset],
                                MIN(ndef_file_len - offset, le));
        bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_success_apdu,
                                sizeof(type_4_tag_success_apdu));
        return Type4TagErrorNone;
    }
...
static Type4TagError type_4_tag_listener_iso_write(Type4TagListener *instance, uint8_t p1,
                                                   uint8_t p2, size_t lc, const uint8_t *data,
                                                   size_t le)
{
    UNUSED(le);
    ...
    if (instance->state == Type4TagListenerStateSelectedNdefMessage) {
        ...
        if (ndef_file_len_new != ndef_file_len) {
            ...
            if (ndef_file_len_new > 0) {
                ...
                if (ndef_file_len > 0) {
                    memcpy(simple_array_get_data(ndef_data_temp),
...
Type4TagError type_4_tag_listener_handle_apdu(Type4TagListener *instance,
                                              const BitBuffer *rx_buffer)
{
    ...
    do {
        ...
        if (!handler) {
            bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_no_cmd_apdu,
                                    sizeof(type_4_tag_no_cmd_apdu));
        ...
        if (body_size == 0) {
            ...
            if (lc == 0 || body_size < lc) {
                bit_buffer_append_bytes(instance->tx_buffer, type_4_tag_bad_params_apdu,
