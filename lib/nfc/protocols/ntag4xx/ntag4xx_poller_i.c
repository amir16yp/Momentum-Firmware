...
Ntag4xxError ntag4xx_poller_send_chunks(Ntag4xxPoller *instance, const BitBuffer *tx_buffer,
                                        BitBuffer *rx_buffer)
{
    furi_check(instance);
    ...
    Iso14443_4aError iso14443_4a_error = nxp_native_command_iso14443_4a_poller(
        instance->iso14443_4a_poller, &status_code, tx_buffer, rx_buffer,
        NxpNativeCommandModeIsoWrapped, instance->tx_buffer, instance->rx_buffer);
