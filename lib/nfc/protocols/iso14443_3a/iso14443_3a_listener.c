...
static bool iso14443_3a_listener_halt_received(BitBuffer *buf)
{
    ...
    do {
        if (bit_buffer_get_size_bytes(buf) != 4)
            break;
        if (!iso14443_crc_check(Iso14443CrcTypeA, buf))
            break;
        if (bit_buffer_get_byte(buf, 0) != 0x50)
            break;
        if (bit_buffer_get_byte(buf, 1) != 0x00)
            break;
...
Iso14443_3aListener *iso14443_3a_listener_alloc(Nfc *nfc, Iso14443_3aData *data)
{
    ...
    nfc_iso14443a_listener_set_col_res_data(instance->nfc, instance->data->uid,
                                            instance->data->uid_len, instance->data->atqa,
                                            instance->data->sak);
...
void iso14443_3a_listener_set_callback(Iso14443_3aListener *instance, NfcGenericCallback callback,
                                       void *context)
{
    furi_assert(instance);
