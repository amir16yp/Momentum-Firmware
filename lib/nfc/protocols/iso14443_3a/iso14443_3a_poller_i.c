...
static Iso14443_3aError iso14443_3a_poller_standard_frame_exchange(Iso14443_3aPoller *instance,
...
Iso14443_3aError iso14443_3a_poller_check_presence(Iso14443_3aPoller *instance)
{
    ...
    do {
        error =
            nfc_iso14443a_poller_trx_short_frame(instance->nfc, NfcIso14443aShortFrameSensReq,
                                                 instance->rx_buffer, ISO14443_3A_FDT_LISTEN_FC);
        if (error != NfcErrorNone) {
            ret = iso14443_3a_poller_process_error(error);
            break;
        }
...
Iso14443_3aError iso14443_3a_poller_halt(Iso14443_3aPoller *instance)
{
    ...
    iso14443_3a_poller_standard_frame_exchange(instance, instance->tx_buffer, instance->rx_buffer,
                                             ...
                                             Iso14443_3aData *iso14443_3a_data)
{
    ...
    do {
        ...
        bit_buffer_write_bytes(instance->rx_buffer, &instance->col_res.sens_resp,
                               sizeof(instance->col_res.sens_resp));
        memcpy(instance->data->atqa, &instance->col_res.sens_resp,
               sizeof(instance->col_res.sens_resp));
        ...
        while (instance->state == Iso14443_3aPollerStateColResInProgress) {
            if (instance->col_res.state == Iso14443_3aPollerColResStateStateNewCascade) {
                ...
                error = nfc_iso14443a_poller_trx_sdd_frame(instance->nfc, instance->tx_buffer,
                                                           instance->rx_buffer,
                                                           ISO14443_3A_FDT_LISTEN_FC);
                if (error != NfcErrorNone) {
                ...
                bit_buffer_write_bytes(instance->rx_buffer, &instance->col_res.sdd_resp,
                ...
                memcpy(instance->col_res.sel_req.nfcid, instance->col_res.sdd_resp.nfcid,
                       sizeof(instance->col_res.sdd_resp.nfcid));
                instance->col_res.sel_req.bcc = instance->col_res.sdd_resp.bss;
                bit_buffer_copy_bytes(instance->tx_buffer, (uint8_t *)&instance->col_res.sel_req,
                ...
                bit_buffer_write_bytes(instance->rx_buffer, &instance->col_res.sel_resp,
                                       sizeof(instance->col_res.sel_resp));
                FURI_LOG_T(TAG, "Sel resp: %02X", instance->col_res.sel_resp.sak);
                if (instance->col_res.sel_req.nfcid[0] == ISO14443_3A_POLLER_SDD_CL) {
                    // Copy part of UID
                    memcpy(&instance->data->uid[instance->data->uid_len],
                           &instance->col_res.sel_req.nfcid[1], 3);
                    ...
                    memcpy(&instance->data->uid[instance->data->uid_len],
                           &instance->col_res.sel_req.nfcid[0], 4);
