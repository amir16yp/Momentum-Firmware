...
Iso14443_4aError iso14443_4a_poller_read_ats(Iso14443_4aPoller *instance, Iso14443_4aAtsData *data)
{
    ...
    do {
        const Iso14443_3aError iso14443_3a_error = iso14443_3a_poller_send_standard_frame(
            instance->iso14443_3a_poller, instance->tx_buffer, instance->rx_buffer,
                                               ...
                                               const BitBuffer *tx_buffer, BitBuffer *rx_buffer)
{
    ...
    do {
        ...
        if (!iso14443_4_layer_decode_response(instance->iso14443_4_layer, rx_buffer,
                                              instance->rx_buffer)) {
            error = Iso14443_4aErrorProtocol;
            break;
        }
                                                       ...
                                                       BitBuffer *rx_buffer)
{
    ...
    do {
        ...
        if (iso14443_3a_error != Iso14443_3aErrorNone) {
            FURI_LOG_T(TAG, "Attempt: %u", ISO14443_4A_SEND_BLOCK_MAX_ATTEMPTS + 1 - attempts_left);
            ...
            error = iso14443_4_layer_decode_response_pwt_ext(instance->iso14443_4_layer, rx_buffer,
                                                             instance->rx_buffer);
