...
static Iso14443_4aListener *iso14443_4a_listener_alloc(Iso14443_3aListener *iso14443_3a_listener,
...
static void iso14443_4a_listener_set_callback(Iso14443_4aListener *instance,
...
static NfcCommand iso14443_4a_listener_run(NfcGenericEvent event, void *context)
{
    ...
    if (iso14443_3a_event->type == Iso14443_3aListenerEventTypeReceivedStandardFrame) {
        if (instance->state == Iso14443_4aListenerStateIdle) {
            if (bit_buffer_get_size_bytes(rx_buffer) == 2 &&
                ...
                if (iso14443_4a_listener_send_ats(instance, &instance->data->ats_data) ==
                    ...
                    if (iso14443_4a_supports_frame_option(instance->data,
                                                          Iso14443_4aFrameOptionCid)) {
                        const uint8_t cid =
                            bit_buffer_get_byte(rx_buffer, 1) & ISO14443_4A_READ_ATS_CID_MASK;
                        iso14443_4_layer_set_cid(instance->iso14443_4_layer, cid);
                    }
                    iso14443_4_layer_set_nad_supported(
                        instance->iso14443_4_layer, iso14443_4a_supports_frame_option(
        ...
        instance->iso14443_4a_event.type =
