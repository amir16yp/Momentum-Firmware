...
Iso14443_4aError iso14443_4a_listener_send_ats(Iso14443_4aListener *instance,
                                               const Iso14443_4aAtsData *data)
{
    ...
    if (data->tl > 1) {
        ...
        if (t1_tk_size != 0) {
            bit_buffer_append_bytes(instance->tx_buffer, simple_array_cget_data(data->t1_tk),
                                    t1_tk_size);
        }
    }
                                                 ...
                                                 const BitBuffer *tx_buffer)
{
    ...
    if (!iso14443_4_layer_encode_response(instance->iso14443_4_layer, tx_buffer,
                                          instance->tx_buffer)) {
