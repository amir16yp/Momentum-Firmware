...
// theoretically result in a 8195 byte response (1 byte flags + 32 byte block * 256 blocks + 2 byte
// crc); for practicality we use a sufficient buffer for a full GET_BLOCKS_SECURITY and limit
// READ_MULTI_BLOCKS to how many blocks we can fit into that buffer size.
