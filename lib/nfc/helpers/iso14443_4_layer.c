...
void iso14443_4_layer_encode_command(Iso14443_4Layer *instance, const BitBuffer *input_data,
                                      ...
                                      const BitBuffer *block_data)
{
    ...
    do {
        if (ISO14443_4_BLOCK_PCB_IS_R_BLOCK(instance->pcb_prev)) {
            ...
            if (!bit_buffer_starts_with_byte(block_data, instance->pcb_prev))
                break;
...
Iso14443_4aError iso14443_4_layer_decode_response_pwt_ext(Iso14443_4Layer *instance,
    ...
    do {
        ...
        case ISO14443_4_BLOCK_PCB_S:
            if ((pcb_field & ISO14443_4_BLOCK_PCB_S_WTX) == ISO14443_4_BLOCK_PCB_S_WTX) {
                ...
                bit_buffer_append_byte(output_data, ISO14443_4_BLOCK_PCB_S |
                                                        ISO14443_4_BLOCK_PCB_S_WTX |
                                                        ISO14443_4_BLOCK_PCB);
...
Iso14443_4LayerResult iso14443_4_layer_decode_command(Iso14443_4Layer *instance,
                                                      ...
                                                      BitBuffer *block_data)
{
    ...
    if (ISO14443_4_BLOCK_PPS_IS_START(ppss)) {
        if (instance->can_pps) {
            ...
            if (pps0 & ISO14443_4_BLOCK_PPS_0_HAS_PPS1) {
                ...
                // TODO: do we need to change bit timings somehow? DRI and DSI mean different bit
                // timing divisors
                UNUSED(dsi);
                UNUSED(dri);
            }
    ...
    if (ISO14443_4_BLOCK_PCB_IS_I_BLOCK(instance->pcb)) {
        if (instance->pcb & ISO14443_4_BLOCK_PCB_I_CID_MASK) {
            const uint8_t cid =
                bit_buffer_get_byte(input_data, prologue_len++) & ISO14443_4_BLOCK_CID_MASK;
            if (instance->cid == ISO14443_4_LAYER_CID_NOT_SUPPORTED || cid != instance->cid) {
                return Iso14443_4LayerResultSkip;
            }
...
bool iso14443_4_layer_encode_response(Iso14443_4Layer *instance, const BitBuffer *input_data,
                                      BitBuffer *block_data)
{
    furi_assert(instance);
