...
static void load_icon_animated(const Icon *original, const char *name, FuriString *path, File *file)
{
...
static void load_icon_static(const Icon *original, const char *name, FuriString *path, File *file)
{
