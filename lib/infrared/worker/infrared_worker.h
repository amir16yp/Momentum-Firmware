...
typedef enum {
    InfraredWorkerGetSignalResponseNew,  /** Signal, provided by callback is new and encoder should
                                            be reseted */
    InfraredWorkerGetSignalResponseSame, /** Signal, provided by callback is same. No encoder
                                            resetting. */
...
typedef InfraredWorkerGetSignalResponse (*InfraredWorkerGetSignalCallback)(
    void *context, InfraredWorker *instance);
...
typedef void (*InfraredWorkerReceivedSignalCallback)(void *context,
