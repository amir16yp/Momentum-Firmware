...
static const InfraredEncoderDecoder infrared_encoder_decoder[] = {
    {
        .decoder = {.alloc = infrared_decoder_nec_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_nec_alloc,
    ...
    {
        .decoder = {.alloc = infrared_decoder_samsung32_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_samsung32_alloc,
    ...
    {
        .decoder = {.alloc = infrared_decoder_rc5_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_rc5_alloc,
    ...
    {
        .decoder = {.alloc = infrared_decoder_rc6_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_rc6_alloc,
    ...
    },
    {
        ...
        .encoder = {.alloc = infrared_encoder_sirc_alloc,
    ...
    {
        .decoder = {.alloc = infrared_decoder_pioneer_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_pioneer_alloc,
    ...
    {
        .decoder = {.alloc = infrared_decoder_kaseikyo_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_kaseikyo_alloc,
    ...
    {
        .decoder = {.alloc = infrared_decoder_rca_alloc,
        ...
        .encoder = {.alloc = infrared_encoder_rca_alloc,
...
InfraredDecoderHandler *infrared_alloc_decoder(void)
{
    InfraredDecoderHandler *handler = malloc(sizeof(InfraredDecoderHandler) +
                                             sizeof(void *) * COUNT_OF(infrared_encoder_decoder));
