...
{
    const uint32_t k =
        data_rate == Iso15693SignalDataRateHi ? ISO15693_SIGNAL_COEFF_HI : ISO15693_SIGNAL_COEFF_LO;
...
static inline uint32_t iso15693_get_sequence_index(Iso15693SignalIndex index,
                                                   Iso15693SignalDataRate data_rate)
{
    return index + data_rate * Iso15693SignalIndexNum;
}

static inline void iso15693_add_byte(Iso15693Signal *instance, Iso15693SignalDataRate data_rate,
                                     uint8_t byte)
{
...
static inline void iso15693_signal_encode(Iso15693Signal *instance,
                                          Iso15693SignalDataRate data_rate, const uint8_t *tx_data,
                                          size_t tx_data_size)
{
    digital_sequence_add_signal(instance->tx_sequence,
                                iso15693_get_sequence_index(Iso15693SignalIndexSof, data_rate));
    ...
    digital_sequence_add_signal(instance->tx_sequence,
                                iso15693_get_sequence_index(Iso15693SignalIndexEof, data_rate));
}
...
static void iso15693_signal_bank_clear(Iso15693Signal *instance, Iso15693SignalDataRate data_rate)
{
    DigitalSignal **bank = instance->banks[data_rate];
...
static void iso15693_signal_bank_register(Iso15693Signal *instance,
                                          Iso15693SignalDataRate data_rate)
{
    for (uint32_t i = 0; i < Iso15693SignalIndexNum; ++i) {
        digital_sequence_register_signal(instance->tx_sequence,
...
void iso15693_signal_tx(Iso15693Signal *instance, Iso15693SignalDataRate data_rate,
                        const uint8_t *tx_data, size_t tx_data_size)
{
    furi_assert(instance);
