...
bool bq25896_init(const FuriHalI2cBusHandle *handle)
{
    ...
    result &= furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x14, *(uint8_t *)&bq25896_regs.r14,
                                       BQ25896_I2C_TIMEOUT);

    // Readout all registers
    result &= furi_hal_i2c_read_mem(handle, BQ25896_ADDRESS, 0x00, (uint8_t *)&bq25896_regs,
                                    sizeof(bq25896_regs), BQ25896_I2C_TIMEOUT);

    // Poll ADC forever
    bq25896_regs.r02.CONV_START = 1;
    bq25896_regs.r02.CONV_RATE = 1;
    result &= furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x02, *(uint8_t *)&bq25896_regs.r02,
                                       BQ25896_I2C_TIMEOUT);

    bq25896_regs.r07.WATCHDOG = WatchdogDisable;
    result &= furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x07, *(uint8_t *)&bq25896_regs.r07,
                                       BQ25896_I2C_TIMEOUT);
    ...
    result &= furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x0A, *(uint8_t *)&bq25896_regs.r0A,
                                       BQ25896_I2C_TIMEOUT);
...
void bq25896_set_boost_lim(const FuriHalI2cBusHandle *handle, BoostLim boost_lim)
{
    ...
    furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x0A, *(uint8_t *)&bq25896_regs.r0A,
                             BQ25896_I2C_TIMEOUT);
}
...
void bq25896_poweroff(const FuriHalI2cBusHandle *handle)
{
    ...
    furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x09, *(uint8_t *)&bq25896_regs.r09,
                             BQ25896_I2C_TIMEOUT);
}

ChrgStat bq25896_get_charge_status(const FuriHalI2cBusHandle *handle)
{
    furi_hal_i2c_read_mem(handle, BQ25896_ADDRESS, 0x00, (uint8_t *)&bq25896_regs,
                          sizeof(bq25896_regs), BQ25896_I2C_TIMEOUT);
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x0B, (uint8_t *)&bq25896_regs.r0B,
                            BQ25896_I2C_TIMEOUT);
...
void bq25896_enable_charging(const FuriHalI2cBusHandle *handle)
{
    ...
    furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x03, *(uint8_t *)&bq25896_regs.r03,
                             BQ25896_I2C_TIMEOUT);
}
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x03, (uint8_t *)&bq25896_regs.r03,
                            BQ25896_I2C_TIMEOUT);
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x06, (uint8_t *)&bq25896_regs.r06,
                            BQ25896_I2C_TIMEOUT);
...
void bq25896_set_vreg_voltage(const FuriHalI2cBusHandle *handle, uint16_t vreg_voltage)
{
    ...
    // Apply changes
    furi_hal_i2c_write_reg_8(handle, BQ25896_ADDRESS, 0x06, *(uint8_t *)&bq25896_regs.r06,
                             BQ25896_I2C_TIMEOUT);
}

bool bq25896_check_otg_fault(const FuriHalI2cBusHandle *handle)
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x0C, (uint8_t *)&bq25896_regs.r0C,
                            BQ25896_I2C_TIMEOUT);
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x11, (uint8_t *)&bq25896_regs.r11,
                            BQ25896_I2C_TIMEOUT);
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x0F, (uint8_t *)&bq25896_regs.r0F,
                            BQ25896_I2C_TIMEOUT);
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x0E, (uint8_t *)&bq25896_regs.r0E,
                            BQ25896_I2C_TIMEOUT);
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x12, (uint8_t *)&bq25896_regs.r12,
                            BQ25896_I2C_TIMEOUT);
...
{
    furi_hal_i2c_read_reg_8(handle, BQ25896_ADDRESS, 0x10, (uint8_t *)&bq25896_regs.r10,
                            BQ25896_I2C_TIMEOUT);
