...
void st25r3916_read_burst_regs(const FuriHalSpiBusHandle *handle, uint8_t reg_start,
...
void st25r3916_write_burst_regs(const FuriHalSpiBusHandle *handle, uint8_t reg_start,
...
void st25r3916_reg_write_fifo(const FuriHalSpiBusHandle *handle, const uint8_t *buff, size_t length)
{
    furi_check(handle);
    furi_check(buff);
    furi_check(length);
...
void st25r3916_write_pta_mem(const FuriHalSpiBusHandle *handle, const uint8_t *values,
                             size_t length)
{
    furi_check(handle);
    furi_check(values);
...
void st25r3916_write_ptf_mem(const FuriHalSpiBusHandle *handle, const uint8_t *values,
                             size_t length)
{
    furi_check(handle);
    furi_check(values);
...
void st25r3916_change_reg_bits(const FuriHalSpiBusHandle *handle, uint8_t reg, uint8_t mask,
                               uint8_t value)
{
    furi_check(handle);
...
void st25r3916_modify_reg(const FuriHalSpiBusHandle *handle, uint8_t reg, uint8_t clr_mask,
                          uint8_t set_mask)
{
    furi_check(handle);
...
void st25r3916_change_test_reg_bits(const FuriHalSpiBusHandle *handle, uint8_t reg, uint8_t mask,
                                    uint8_t value)
{
    furi_check(handle);
