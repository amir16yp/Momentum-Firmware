...
bool ds_generic_load(FlipperFormat *ff, uint32_t format_version, iButtonProtocolData *protocol_data)
{
    DallasGenericProtocolData *data = protocol_data;
...
void ds_generic_get_editable_data(iButtonEditableData *editable_data,
