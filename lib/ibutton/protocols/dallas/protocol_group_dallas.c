...
static bool ibutton_protocol_group_dallas_get_id_by_name(iButtonProtocolGroupDallas *group,
...
static uint32_t ibutton_protocol_group_dallas_get_features(iButtonProtocolGroupDallas *group,
                                                           iButtonProtocolLocalId id)
{
    UNUSED(group);
...
static const char *ibutton_protocol_group_dallas_get_manufacturer(iButtonProtocolGroupDallas *group,
                                                                  iButtonProtocolLocalId id)
{
    UNUSED(group);
    furi_assert(id < iButtonProtocolDSMax);
...
static const char *ibutton_protocol_group_dallas_get_name(iButtonProtocolGroupDallas *group,
                                                          iButtonProtocolLocalId id)
{
    UNUSED(group);
    furi_assert(id < iButtonProtocolDSMax);
...
ibutton_protocol_group_dallas_get_id_by_family_code(uint8_t family_code)
{
    ...
    for (id = 0; id < iButtonProtocolDSGeneric; ++id) {
        if (ibutton_protocols_dallas[id]->family_code == family_code)
            break;
    }
...
static bool ibutton_protocol_group_dallas_read(iButtonProtocolGroupDallas *group,
...
static bool ibutton_protocol_group_dallas_write_id(iButtonProtocolGroupDallas *group,
                                                   iButtonProtocolData *data,
                                                   iButtonProtocolLocalId id)
{
    furi_assert(id < iButtonProtocolDSMax);
...
static bool ibutton_protocol_group_dallas_write_copy(iButtonProtocolGroupDallas *group,
                                                     iButtonProtocolData *data,
                                                     iButtonProtocolLocalId id)
{
    furi_assert(id < iButtonProtocolDSMax);
...
static void ibutton_protocol_group_dallas_emulate_start(iButtonProtocolGroupDallas *group,
                                                        iButtonProtocolData *data,
                                                        iButtonProtocolLocalId id)
{
    furi_assert(id < iButtonProtocolDSMax);
...
static void ibutton_protocol_group_dallas_emulate_stop(iButtonProtocolGroupDallas *group,
                                                       iButtonProtocolData *data,
                                                       iButtonProtocolLocalId id)
{
    furi_assert(id < iButtonProtocolDSMax);
...
static bool ibutton_protocol_group_dallas_save(iButtonProtocolGroupDallas *group,
                                               const iButtonProtocolData *data,
                                               iButtonProtocolLocalId id, FlipperFormat *ff)
{
    UNUSED(group);
    furi_assert(id < iButtonProtocolDSMax);
...
static bool ibutton_protocol_group_dallas_load(iButtonProtocolGroupDallas *group,
                                               iButtonProtocolData *data, iButtonProtocolLocalId id,
                                               uint32_t version, FlipperFormat *ff)
{
    UNUSED(group);
    furi_assert(id < iButtonProtocolDSMax);
...
static void ibutton_protocol_group_dallas_render_uid(iButtonProtocolGroupDallas *group,
                                                     const iButtonProtocolData *data,
                                                     iButtonProtocolLocalId id, FuriString *result)
{
    UNUSED(group);
    furi_assert(id < iButtonProtocolDSMax);
    const iButtonProtocolDallasBase *protocol = ibutton_protocols_dallas[id];
...
static void ibutton_protocol_group_dallas_render_data(iButtonProtocolGroupDallas *group,
                                                      const iButtonProtocolData *data,
                                                      iButtonProtocolLocalId id, FuriString *result)
{
    UNUSED(group);
...
static void ibutton_protocol_group_dallas_render_brief_data(iButtonProtocolGroupDallas *group,
                                                            const iButtonProtocolData *data,
                                                            iButtonProtocolLocalId id,
                                                            FuriString *result)
{
...
static void ibutton_protocol_group_dallas_render_error(iButtonProtocolGroupDallas *group,
                                                       const iButtonProtocolData *data,
                                                       iButtonProtocolLocalId id,
                                                       FuriString *result)
{
...
static bool ibutton_protocol_group_dallas_is_valid(iButtonProtocolGroupDallas *group,
                                                   const iButtonProtocolData *data,
                                                   iButtonProtocolLocalId id)
{
    UNUSED(group);
...
static void ibutton_protocol_group_dallas_get_editable_data(iButtonProtocolGroupDallas *group,
                                                            iButtonProtocolData *data,
                                                            iButtonProtocolLocalId id,
...
static void ibutton_protocol_group_dallas_apply_edits(iButtonProtocolGroupDallas *group,
                                                      iButtonProtocolData *data,
                                                      iButtonProtocolLocalId id)
{
    UNUSED(group);
...
const iButtonProtocolGroupBase ibutton_protocol_group_dallas = {
    ...
    .get_features = (iButtonProtocolGroupGetFeaturesFunc)ibutton_protocol_group_dallas_get_features,
