...
static bool ibutton_protocol_group_misc_get_id_by_name(iButtonProtocolGroupMisc *group,
                                                       iButtonProtocolLocalId *id, const char *name)
{
...
static uint32_t ibutton_protocol_group_misc_get_features(iButtonProtocolGroupMisc *group,
...
static const char *ibutton_protocol_group_misc_get_manufacturer(iButtonProtocolGroupMisc *group,
                                                                iButtonProtocolLocalId id)
{
    return protocol_dict_get_manufacturer(group->dict, id);
}

static const char *ibutton_protocol_group_misc_get_name(iButtonProtocolGroupMisc *group,
                                                        iButtonProtocolLocalId id)
{
...
static bool ibutton_protocol_group_misc_read(iButtonProtocolGroupMisc *group,
                                             iButtonProtocolData *data, iButtonProtocolLocalId *id)
{
    ...
    for (;;) {
        LevelDuration level;
        size_t ret = furi_stream_buffer_receive(read_context.stream, &level, sizeof(LevelDuration),
                                                IBUTTON_MISC_READ_TIMEOUT);
        ...
        if (ret > 0) {
            ...
            *id = decoded_index;
            ...
            protocol_dict_get_data(group->dict, decoded_index, data,
...
static void ibutton_protocol_group_misc_emulate_start(iButtonProtocolGroupMisc *group,
...
static void ibutton_protocol_group_misc_emulate_stop(iButtonProtocolGroupMisc *group,
                                                     iButtonProtocolData *data,
                                                     iButtonProtocolLocalId id)
{
    UNUSED(group);
...
static bool ibutton_protocol_group_misc_save(iButtonProtocolGroupMisc *group,
...
static bool ibutton_protocol_group_misc_load(iButtonProtocolGroupMisc *group,
                                             iButtonProtocolData *data, iButtonProtocolLocalId id,
...
static void ibutton_protocol_group_misc_render_uid(iButtonProtocolGroupMisc *group,
                                                   const iButtonProtocolData *data,
...
static void ibutton_protocol_group_misc_render_data(iButtonProtocolGroupMisc *group,
                                                    const iButtonProtocolData *data,
                                                    iButtonProtocolLocalId id, FuriString *result)
{
    const size_t data_size = protocol_dict_get_data_size(group->dict, id);
...
static void ibutton_protocol_group_misc_render_brief_data(iButtonProtocolGroupMisc *group,
                                                          const iButtonProtocolData *data,
                                                          iButtonProtocolLocalId id,
                                                          FuriString *result)
{
...
static void ibutton_protocol_group_misc_render_error(iButtonProtocolGroupMisc *group,
                                                     const iButtonProtocolData *data,
                                                     iButtonProtocolLocalId id, FuriString *result)
{
    UNUSED(group);
...
static bool ibutton_protocol_group_misc_is_valid(iButtonProtocolGroupMisc *group,
                                                 const iButtonProtocolData *data,
                                                 iButtonProtocolLocalId id)
{
    UNUSED(group);
...
static void ibutton_protocol_group_misc_get_editable_data(iButtonProtocolGroupMisc *group,
                                                          iButtonProtocolData *data,
                                                          iButtonProtocolLocalId id,
...
static void ibutton_protocol_group_misc_apply_edits(iButtonProtocolGroupMisc *group,
                                                    iButtonProtocolData *data,
                                                    iButtonProtocolLocalId id)
{
    const size_t data_size = protocol_dict_get_data_size(group->dict, id);
