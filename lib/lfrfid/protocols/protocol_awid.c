...
static bool protocol_awid_can_be_decoded(uint8_t *data)
{
    ...
    // 0            10            20            30              40            50              60
    // |            |             |             |               |             |               |
    // 01234567 890 1 234 5 678 9 012 3 456 7 890 1 234 5 678 9 012 3 456 7 890 1 234 5 678 9 012 3
    // - to 96
    // -----------------------------------------------------------------------------
    // 00000001 000 1 110 1 101 1 011 1 101 1 010 0 000 1 000 1 010 0 001 0 110 1 100 0 000 1 000 1
    // preamble bbb o bbb o bbw o fff o fff o ffc o ccc o ccc o ccc o ccc o ccc o wxx o xxx o xxx o
    // - to 96
    //          |---26 bit---|    |-----117----||-------------142-------------|
    ...
    do {
        ...
        if (data[0] != 0b00000001 || data[AWID_ENCODED_DATA_LAST] != 0b00000001)
            break;
