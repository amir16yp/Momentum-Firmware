...
typedef void (*SubGhzReceiverCallback)(SubGhzReceiver *decoder,
 ...
 */
void subghz_receiver_set_rx_callback(SubGhzReceiver *instance, SubGhzReceiverCallback callback,
                                     void *context);
 ...
 */
void subghz_receiver_set_ignore_filter(SubGhzReceiver *instance,
 ...
 */
SubGhzProtocolDecoderBase *subghz_receiver_search_decoder_base_by_name(SubGhzReceiver *instance,
