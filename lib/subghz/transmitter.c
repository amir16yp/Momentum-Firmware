...
SubGhzTransmitter *subghz_transmitter_alloc_init(SubGhzEnvironment *environment,
...
SubGhzProtocolStatus subghz_transmitter_deserialize(SubGhzTransmitter *instance,
                                                    FlipperFormat *flipper_format)
{
    ...
    if (instance->protocol && instance->protocol->encoder &&
        ...
        ret = instance->protocol->encoder->deserialize(instance->protocol_instance, flipper_format);
    }
    return ret;
}
