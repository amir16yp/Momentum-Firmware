 ...
 * @return SubGhzProtocolEncoderKingGates_stylo_4k* pointer to a
...
subghz_protocol_encoder_kinggates_stylo_4k_deserialize(void *context,
 ...
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return SubGhzProtocolDecoderKingGates_stylo_4k* pointer to a
 ...
 */
SubGhzProtocolStatus
subghz_protocol_decoder_kinggates_stylo_4k_deserialize(void *context,
                                                       FlipperFormat *flipper_format);
