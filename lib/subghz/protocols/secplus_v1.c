...
static bool subghz_protocol_encoder_secplus_v1_get_upload(SubGhzProtocolEncoderSecPlus_v1 *instance)
{
    ...
    instance->encoder.upload[index++] =
        level_duration_make(false, (uint32_t)subghz_protocol_secplus_v1_const.te_short * (116 + 3));
    instance->encoder.upload[index++] =
    ...
    for (uint8_t i = SECPLUS_V1_PACKET_1_INDEX_BASE + 1; i < SECPLUS_V1_PACKET_1_INDEX_BASE + 21;
        ...
        case SECPLUS_V1_BIT_0:
            instance->encoder.upload[index++] =
                level_duration_make(false, (uint32_t)subghz_protocol_secplus_v1_const.te_short * 3);
            instance->encoder.upload[index++] =
                level_duration_make(true, (uint32_t)subghz_protocol_secplus_v1_const.te_short);
            break;
        case SECPLUS_V1_BIT_1:
            instance->encoder.upload[index++] =
                level_duration_make(false, (uint32_t)subghz_protocol_secplus_v1_const.te_short * 2);
            instance->encoder.upload[index++] =
...
static bool subghz_protocol_secplus_v1_encode(SubGhzProtocolEncoderSecPlus_v1 *instance)
{
    ...
    //  range of 0xE6000000 - 0xFFFFFFFF
...
SubGhzProtocolStatus subghz_protocol_encoder_secplus_v1_deserialize(void *context,
...
static void subghz_protocol_secplus_v1_decode(SubGhzProtocolDecoderSecPlus_v1 *instance)
{
    ...
    instance->generic.data_count_bit = subghz_protocol_secplus_v1_const.min_count_bit_for_found * 2;
}
...
void subghz_protocol_decoder_secplus_v1_feed(void *context, bool level, uint32_t duration)
{
    ...
    case SecPlus_v1DecoderStepSearchStartBit:
        if (level) {
            ...
            } else if (DURATION_DIFF(duration, subghz_protocol_secplus_v1_const.te_long) <
                       subghz_protocol_secplus_v1_const.te_delta) {
    ...
    case SecPlus_v1DecoderStepDecoderData:
        if (level && (instance->decoder.decode_count_bit <=
            ...
            if ((DURATION_DIFF(instance->decoder.te_last,
                               subghz_protocol_secplus_v1_const.te_short * 3) <
                ...
                instance->decoder.parser_step = SecPlus_v1DecoderStepSaveDuration;
                                      ...
                                      subghz_protocol_secplus_v1_const.te_short * 2) <
                ...
                instance->decoder.parser_step = SecPlus_v1DecoderStepSaveDuration;
                                      ...
                                      subghz_protocol_secplus_v1_const.te_short) <
                        subghz_protocol_secplus_v1_const.te_delta) &&
...
SubGhzProtocolStatus subghz_protocol_decoder_secplus_v1_serialize(void *context,
                                                                  FlipperFormat *flipper_format,
...
SubGhzProtocolStatus subghz_protocol_decoder_secplus_v1_deserialize(void *context,
                                                                    FlipperFormat *flipper_format)
{
    furi_assert(context);
    SubGhzProtocolDecoderSecPlus_v1 *instance = context;
...
void subghz_protocol_decoder_secplus_v1_get_string(void *context, FuriString *output)
{
    ...
    furi_string_cat_printf(output,
                           ...
                           (uint32_t)instance->generic.data, id1, id0);
