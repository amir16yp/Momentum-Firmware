...
static void subghz_protocol_power_smart_remote_controller(SubGhzBlockGeneric *instance)
{
     ...
     *                           XXXX = ~ZZZZ, YY=(~WW)-1
     * Example:
     *                               SYNC1 K1 CHANNEL DATA1   K2 DATA2    SYNC2  ~K1 ~CHANNEL ~DATA2
     * ~K2 (~DATA2)-1 0xFD2137ACAADEC852 => 11111101 0 010000 10011011 1 10101100 10101010  1
     * 1011110 1100100  0  01010010 0xFDA137ACAA5EC852 => 11111101 1 010000 10011011 1 10101100
     * 10101010  0  1011110 1100100  0  01010010 0xFDA136ACAA5EC952 => 11111101 1 010000 10011011 0
     * 10101100 10101010  0  1011110 1100100  1  01010010
     *
     * Key:
     *       K1K2
     *        0 0 - key_unknown
...
SubGhzProtocolStatus subghz_protocol_encoder_power_smart_deserialize(void *context,
...
void subghz_protocol_decoder_power_smart_feed(void *context, bool level, volatile uint32_t duration)
{
    furi_assert(context);
    SubGhzProtocolDecoderPowerSmart *instance = context;
    ...
    if (!level) {
        ...
        } else if (DURATION_DIFF(duration, subghz_protocol_power_smart_const.te_long) <
...
SubGhzProtocolStatus subghz_protocol_decoder_power_smart_serialize(void *context,
                                                                   FlipperFormat *flipper_format,
...
SubGhzProtocolStatus subghz_protocol_decoder_power_smart_deserialize(void *context,
                                                                     FlipperFormat *flipper_format)
{
    furi_assert(context);
    SubGhzProtocolDecoderPowerSmart *instance = context;
