...
{
    instance->serial = (instance->data >> 15) << 9 | (instance->data & 0x1FF); // 26 bits for serial
        ...
        if (!level) {
            ...
            if ((DURATION_DIFF(instance->decoder.te_last, subghz_protocol_nord_ice_const.te_short) <
                ...
                // Bit 1 is long and short timing = 800us HIGH (te_last) and 300us LOW
                                      ...
                                      subghz_protocol_nord_ice_const.te_long) <
                        subghz_protocol_nord_ice_const.te_delta) &&
                ...
                if ((DURATION_DIFF(instance->decoder.te_last,
                                   subghz_protocol_nord_ice_const.te_short) <
                     subghz_protocol_nord_ice_const.te_delta)) {
                    subghz_protocol_blocks_add_bit(&instance->decoder, 0);
                }
                if ((DURATION_DIFF(instance->decoder.te_last,
                                                                  ...
                                                                  FlipperFormat *flipper_format)
{
    ...
    return subghz_block_generic_deserialize_check_count_bit(
        &instance->generic, flipper_format, subghz_protocol_nord_ice_const.min_count_bit_for_found);
}
...
void subghz_protocol_decoder_nord_ice_get_string(void *context, FuriString *output)
{
    ...
    furi_string_cat_printf(output,
                           ...
                           (code_found_reverse & 0xFFFFFFFFF), instance->generic.serial,
