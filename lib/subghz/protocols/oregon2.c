...
void ws_protocol_decoder_oregon2_feed(void *context, bool level, uint32_t duration)
{
    ...
    case Oregon2DecoderStepVarData:
        ...
        if (instance->decoder.decode_count_bit == instance->var_bits + OREGON2_CHECKSUM_BITS) {
            ...
            instance->var_data =
                (instance->var_data & 0x55555555) << 1 | (instance->var_data & 0xAAAAAAAA) >> 1;
            instance->var_data =
                (instance->var_data & 0x33333333) << 2 | (instance->var_data & 0xCCCCCCCC) >> 2;

            ws_oregon2_decode_var_data(&instance->generic,
...
SubGhzProtocolStatus ws_protocol_decoder_oregon2_serialize(void *context,
                                                           ...
                                                           SubGhzRadioPreset *preset)
{
    ...
    if (!flipper_format_write_hex(flipper_format, "VarData", (const uint8_t *)&instance->var_data,
...
SubGhzProtocolStatus ws_protocol_decoder_oregon2_deserialize(void *context,
                                                             FlipperFormat *flipper_format)
{
    furi_assert(context);
    WSProtocolDecoderOregon2 *instance = context;
    ...
    do {
        ...
        if (!flipper_format_read_hex(flipper_format, "VarData", (uint8_t *)&instance->var_data,
