...
SubGhzProtocolStatus subghz_protocol_encoder_hay21_deserialize(void *context,
        ...
        if (!level) {
            ...
            if ((DURATION_DIFF(instance->decoder.te_last, subghz_protocol_hay21_const.te_long) <
                ...
                // Bit 0 is short + long timing
                                      ...
                                      subghz_protocol_hay21_const.te_short) <
                        subghz_protocol_hay21_const.te_delta) &&
...
SubGhzProtocolStatus subghz_protocol_decoder_hay21_serialize(void *context,
                                                             FlipperFormat *flipper_format,
...
SubGhzProtocolStatus subghz_protocol_decoder_hay21_deserialize(void *context,
                                                               FlipperFormat *flipper_format)
{
    furi_assert(context);
    SubGhzProtocolDecoderHay21 *instance = context;
...
void subghz_protocol_decoder_hay21_get_string(void *context, FuriString *output)
{
    ...
    furi_string_cat_printf(output,
                           ...
                           (uint8_t)(instance->generic.serial & 0xFF), instance->generic.btn,
