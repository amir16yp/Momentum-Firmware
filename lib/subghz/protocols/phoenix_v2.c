                                            ...
                                            SubGhzRadioPreset *preset)
{
    ...
    uint16_t encrypted_counter =
        (uint16_t)subghz_protocol_phoenix_v2_encrypt_counter(local_data_rev, instance->generic.cnt);

    instance->generic.data =
        subghz_protocol_blocks_reverse_key((uint64_t)(((uint64_t)encrypted_counter << 40) |
 ...
 */
static bool subghz_protocol_encoder_phoenix_v2_get_upload(SubGhzProtocolEncoderPhoenix_V2 *instance)
{
...
SubGhzProtocolStatus subghz_protocol_encoder_phoenix_v2_deserialize(void *context,
    ...
    case Phoenix_V2DecoderStepCheckDuration:
        if (level) {
            if ((DURATION_DIFF(instance->decoder.te_last,
                               subghz_protocol_phoenix_v2_const.te_short) <
                 subghz_protocol_phoenix_v2_const.te_delta) &&
                ...
                instance->decoder.parser_step = Phoenix_V2DecoderStepSaveDuration;
                                      ...
                                      subghz_protocol_phoenix_v2_const.te_long) <
                        subghz_protocol_phoenix_v2_const.te_delta * 3) &&
...
SubGhzProtocolStatus subghz_protocol_decoder_phoenix_v2_serialize(void *context,
                                                                  FlipperFormat *flipper_format,
                                                                  SubGhzRadioPreset *preset)
{
    furi_assert(context);
...
SubGhzProtocolStatus subghz_protocol_decoder_phoenix_v2_deserialize(void *context,
                                                                    FlipperFormat *flipper_format)
{
    furi_assert(context);
    SubGhzProtocolDecoderPhoenix_V2 *instance = context;
