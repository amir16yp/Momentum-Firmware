...
void ws_protocol_decoder_oregon3_feed(void *context, bool level, uint32_t duration)
{
    ...
    if (manchester_advance(instance->manchester_state, event, &instance->manchester_state,
                           &instance->prev_bit)) {
    ...
    case Oregon3DecoderStepVarData:
        ...
        if (instance->decoder.decode_count_bit == instance->var_bits + OREGON3_CHECKSUM_BITS) {
            ...
            ws_oregon3_decode_var_data(&instance->generic,
...
SubGhzProtocolStatus ws_protocol_decoder_oregon3_serialize(void *context,
...
SubGhzProtocolStatus ws_protocol_decoder_oregon3_deserialize(void *context,
                                                             FlipperFormat *flipper_format)
{
    furi_assert(context);
    WSProtocolDecoderOregon3 *instance = context;
