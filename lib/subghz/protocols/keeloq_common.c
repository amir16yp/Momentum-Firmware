...
inline uint64_t subghz_protocol_keeloq_common_secure_learning(uint32_t data, uint32_t seed,
                                                              const uint64_t key)
{
    uint32_t k1, k2;
...
inline uint64_t subghz_protocol_keeloq_common_faac_learning(const uint32_t seed, const uint64_t key)
{
    uint16_t hs = seed >> 16;
...
inline uint64_t subghz_protocol_keeloq_common_magic_serial_type1_learning(uint32_t data,
                                                                          uint64_t man)
{
...
inline uint64_t subghz_protocol_keeloq_common_magic_serial_type2_learning(uint32_t data,
                                                                          uint64_t man)
{
...
inline uint64_t subghz_protocol_keeloq_common_magic_serial_type3_learning(uint32_t data,
                                                                          uint64_t man)
{
...
static inline uint32_t subghz_protocol_keeloq_common_manufacturer_nl_extend(uint32_t x,
                                                                            uint32_t k_lo,
                                                                            uint32_t k_hi,
...
inline uint32_t subghz_protocol_keeloq_common_decrypt_derived(uint32_t hop_encrypted,
                                                              uint64_t derived_manufacturing_key,
                                                              uint32_t outer_limit)
{
    return subghz_protocol_keeloq_common_manufacturer_nl_extend(
        hop_encrypted, (uint32_t)derived_manufacturing_key,
        (uint32_t)(derived_manufacturing_key >> 32u), outer_limit);
}
...
inline uint64_t subghz_protocol_keeloq_common_learning_erreka(uint32_t data, uint32_t mix,
                                                              const uint64_t key)
{
    uint32_t d = data & 0x0FFFFFFFu;
