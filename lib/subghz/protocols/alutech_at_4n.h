 ...
 * @return SubGhzProtocolEncoderAlutech_at_4n* pointer to a SubGhzProtocolEncoderAlutech_at_4n
 * instance
 */
 ...
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return SubGhzProtocolDecoderAlutech_at_4n* pointer to a SubGhzProtocolDecoderAlutech_at_4n
 * instance
 */
