...
SubGhzProtocolStatus subghz_protocol_encoder_smc5326_deserialize(void *context,
        ...
        if (!level) {
            ...
            if ((DURATION_DIFF(instance->decoder.te_last, subghz_protocol_smc5326_const.te_short) <
                ...
                instance->decoder.parser_step = SMC5326DecoderStepSaveDuration;
                                      ...
                                      subghz_protocol_smc5326_const.te_long) <
                        subghz_protocol_smc5326_const.te_delta * 3) &&
...
SubGhzProtocolStatus subghz_protocol_decoder_smc5326_serialize(void *context,
                                                               FlipperFormat *flipper_format,
...
SubGhzProtocolStatus subghz_protocol_decoder_smc5326_deserialize(void *context,
                                                                 FlipperFormat *flipper_format)
{
    furi_assert(context);
    SubGhzProtocolDecoderSMC5326 *instance = context;
...
void subghz_protocol_decoder_smc5326_get_string(void *context, FuriString *output)
{
    ...
    furi_string_cat_printf(output,
                           ...
                           (uint32_t)(instance->generic.data & 0x1FFFFFF), instance->te,
                           SHOW_DIP_P(data, DIP_P), SHOW_DIP_P(data, DIP_O));
