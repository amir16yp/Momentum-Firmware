 ...
 * @return SubGhzProtocolEncoderHormannBiSecur* pointer to a SubGhzProtocolEncoderHormannBiSecur
 * instance
 */
 ...
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return SubGhzProtocolDecoderHormannBiSecur* pointer to a SubGhzProtocolDecoderHormannBiSecur
 * instance
 */
