...
{
    uint8_t msg[] = {instance->upper_decode_data >> 48,   instance->upper_decode_data >> 40,
                     instance->upper_decode_data >> 32,   instance->upper_decode_data >> 24,
                     instance->upper_decode_data >> 16,   instance->upper_decode_data >> 8,
                     instance->upper_decode_data,         instance->decoder.decode_data >> 56,
                     instance->decoder.decode_data >> 48, instance->decoder.decode_data >> 40,
    ...
    case EmosE601xDecoderStepCheckPreamble:
        if (level) {
            ...
            if ((DURATION_DIFF(instance->decoder.te_last,
                               ws_protocol_emose601x_const.te_short * 7) <
                 ws_protocol_emose601x_const.te_delta * 2) &&
        ...
        if (!level) {
            if ((DURATION_DIFF(instance->decoder.te_last, ws_protocol_emose601x_const.te_short) <
                ...
                (DURATION_DIFF(duration, ws_protocol_emose601x_const.te_long) <
                 ws_protocol_emose601x_const.te_delta)) {
                subghz_protocol_blocks_add_to_128_bit(&instance->decoder, 0,
                                                      &instance->upper_decode_data);
                instance->decoder.parser_step = EmosE601xDecoderStepSaveDuration;
            } else if ((DURATION_DIFF(instance->decoder.te_last,
                                      ws_protocol_emose601x_const.te_long) <
                        ws_protocol_emose601x_const.te_delta) &&
                       (DURATION_DIFF(duration, ws_protocol_emose601x_const.te_short) <
                        ws_protocol_emose601x_const.te_delta)) {
                subghz_protocol_blocks_add_to_128_bit(&instance->decoder, 1,
                                                      &instance->upper_decode_data);
                instance->decoder.parser_step = EmosE601xDecoderStepSaveDuration;
            } else {
                instance->decoder.parser_step = EmosE601xDecoderStepReset;
...
SubGhzProtocolStatus ws_protocol_decoder_emose601x_serialize(void *context,
...
SubGhzProtocolStatus ws_protocol_decoder_emose601x_deserialize(void *context,
                                                               FlipperFormat *flipper_format)
{
    furi_assert(context);
    WSProtocolDecoderEmosE601x *instance = context;
