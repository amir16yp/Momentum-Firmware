 ...
 */
static bool subghz_protocol_encoder_princeton_get_upload(SubGhzProtocolEncoderPrinceton *instance)
{
...
SubGhzProtocolStatus subghz_protocol_encoder_princeton_deserialize(void *context,
                                                                   FlipperFormat *flipper_format)
{
    ...
    do {
        ...
        // Optional value
        if (!flipper_format_read_uint32(flipper_format, "Guard_time",
                                        (uint32_t *)&instance->guard_time, 1)) {
    ...
    case PrincetonDecoderStepCheckDuration:
        if (!level) {
            if (duration >= ((uint32_t)subghz_protocol_princeton_const.te_long * 2)) {
                ...
                if (instance->decoder.decode_count_bit ==
                    ...
                    if ((instance->last_data == instance->decoder.decode_data) &&
                        ...
                        // Guard Time value should be between 15 -> 72 otherwise default value will
                        // be used
                        if ((instance->guard_time < 15) || (instance->guard_time > 72)) {
                            instance->guard_time = PRINCETON_GUARD_TIME_DEFALUT;
                        }
            ...
            if ((DURATION_DIFF(instance->decoder.te_last,
                               subghz_protocol_princeton_const.te_short) <
                ...
                instance->decoder.parser_step = PrincetonDecoderStepSaveDuration;
                                      ...
                                      subghz_protocol_princeton_const.te_long) <
                        subghz_protocol_princeton_const.te_delta * 3) &&
...
SubGhzProtocolStatus subghz_protocol_decoder_princeton_serialize(void *context,
                                                                 FlipperFormat *flipper_format,
...
SubGhzProtocolStatus subghz_protocol_decoder_princeton_deserialize(void *context,
                                                                   FlipperFormat *flipper_format)
{
    furi_assert(context);
    SubGhzProtocolDecoderPrinceton *instance = context;
...
void subghz_protocol_decoder_princeton_get_string(void *context, FuriString *output)
{
    ...
    SubGhzProtocolDecoderPrinceton *instance = context;
    subghz_protocol_princeton_check_remote_controller(&instance->generic);
    uint32_t data_rev = subghz_protocol_blocks_reverse_key(instance->generic.data,
    ...
    if (instance->generic.btn == 0x30 || instance->generic.btn == 0xC0 ||
        ...
        furi_string_cat_printf(output,
                               ...
                               (uint32_t)(instance->generic.data & 0xFFFFFF), data_rev,
                               instance->generic.serial,
                               (instance->generic.btn == 0xF3 || instance->generic.btn == 0xFC)
                                   ? instance->generic.btn & 0xF
                                   : instance->generic.btn,
                               instance->te, instance->guard_time);
    } else {
        ...
        furi_string_cat_printf(output,
                               ...
                               instance->generic.protocol_name, instance->generic.data_count_bit,
                               (uint32_t)(instance->generic.data & 0xFFFFFF), data_rev,
                               instance->generic.serial, instance->generic.btn, instance->te,
                               instance->guard_time);
    }
}
