        ...
        if (!level) {
            if (DURATION_DIFF(duration, ws_protocol_thermopro_tx4_const.te_short * 18) <
                ...
                break;
                                      ...
                                      ws_protocol_thermopro_tx4_const.te_short) <
...
SubGhzProtocolStatus ws_protocol_decoder_thermopro_tx4_serialize(void *context,
...
SubGhzProtocolStatus ws_protocol_decoder_thermopro_tx4_deserialize(void *context,
                                                                   FlipperFormat *flipper_format)
{
    furi_assert(context);
    WSProtocolDecoderThermoPRO_TX4 *instance = context;
