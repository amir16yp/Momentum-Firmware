 ...
 * The size may be larger than stream size, the stream will be cleared from current RW pointer to
 * the end.
 * @param stream Stream instance
...
/**
 * Copy data from one stream to another. Data will be copied from current RW pointer and to current
 * RW pointer.
 * @param stream_from
 * @param stream_to
 * @param size
...
/**
 * Copy data from one stream to another. Data will be copied from start of one stream and to start
 * of other stream.
 * @param stream_from
 * @param stream_to
 * @return size_t
...
/**
 * Loads data to the stream from a file. Data will be loaded to the current RW pointer. RW pointer
 * will be moved to the end of the stream.
 * @param stream Stream instance
 * @param storage
 * @param path
 * @return size_t
...
/**
 * Writes data from a stream to a file. Data will be saved starting from the current RW pointer. RW
