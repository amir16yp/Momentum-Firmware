 ...
 * @return True on success, False on failure. You need to close the file even if the open operation
 * failed.
 */
bool buffered_file_stream_open(Stream *stream, const char *path, FS_AccessMode access_mode,
