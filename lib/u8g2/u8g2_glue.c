...
static const u8x8_display_info_t u8x8_st756x_128x64_display_info = {
    ...
    .sck_pulse_width_ns = 120, /* half of cycle time (100ns according to datasheet), AVR: below 70:
                                  8 MHz, >= 70 --> 4MHz clock */
...
void u8g2_Setup_st756x_flipper(u8g2_t *u8g2, const u8g2_cb_t *rotation, u8x8_msg_cb byte_cb,
