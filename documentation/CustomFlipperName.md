...
## Instruction
1. Go to Rectum -> Misc -> Spoofing Options -> Flipper Name
...
3. You will need to exit from Rectum app and Flipper will automatically reboot!
...
Currently, changing Flipper name on Rectum Firmware also affects:
